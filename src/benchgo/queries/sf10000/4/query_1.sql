...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2001-04-25','2001-09-22','2001-11-16')))
...
and d_date between '1998-03-13' and 
        (cast('1998-03-13' as date) + 90 days)
...
and d_date between '1998-01-27' and 
        (cast('1998-01-27' as date) + 90 days)
...
where 
	...
	and d_date between cast('1999-05-21' as date) 
				and (cast('1999-05-21' as date) + 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select  
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('1999-06-23' as date) - 30 days)
...
where 
	...
	and d_date between cast('1998-02-08' as date) 
				and (cast('1998-02-08' as date) + 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('2002-08-22' as date) 
                  and (cast('2002-08-22' as date) +  14 days)
...
select  i_item_id
 ...
 and d_date between cast('2002-03-15' as date) and (cast('2002-03-15' as date) +  60 days)
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2001-05-26' as date) and (cast('2001-05-26' as date) +  60 days)
...
with ssr as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2001-08-06' as date) 
                  and (cast('2001-08-06' as date) +  30 days)
       and ss_store_sk = s_store_sk
       and ss_item_sk = i_item_sk
...
select  *
 from(select w_warehouse_name
            ,i_item_id
            ,sum(case when (cast(d_date as date) < cast ('2002-05-06' as date))
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between (cast ('2002-05-06' as date) - 30 days)
                    and (cast ('2002-05-06' as date) + 30 days)
