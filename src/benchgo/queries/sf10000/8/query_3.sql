...
with ssr as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2002-08-23' as date) 
                  and (cast('2002-08-23' as date) +  30 days)
...
select  i_item_id
 ...
 and d_date between cast('1998-01-09' as date) and (cast('1998-01-09' as date) +  60 days)
...
select  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between (cast ('2000-03-02' as date) - 30 days)
                    and (cast ('2000-03-02' as date) + 30 days)
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2002-03-19' as date) and (cast('2002-03-19' as date) +  60 days)
...
select  
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('2000-03-05' as date) - 30 days)
                and (cast ('2000-03-05' as date) + 30 days) 
 group by
    w_state,i_item_id
...
and d_date between '1999-02-27' and 
        (cast('1999-02-27' as date) + 90 days)
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('1999-06-25','1999-08-06','1999-11-04')))
...
where 
	...
	and d_date between cast('1999-02-21' as date) 
				and (cast('1999-02-21' as date) + 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
and d_date between '2001-02-09' and 
        (cast('2001-02-09' as date) + 90 days)
...
where 
	ss_item_sk = i_item_sk 
  	...
  	and ss_sold_date_sk = d_date_sk
	and d_date between cast('2000-04-30' as date) 
				and (cast('2000-04-30' as date) + 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select  i_item_id
 ...
 and d_date between cast('2001-01-29' as date) 
 				and (cast('2001-01-29' as date) + 30 days)
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
