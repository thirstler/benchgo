...
and d_date between '2002-01-20' and 
        (cast('2002-01-20' as date) + 90 days)
...
select  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between (cast ('2001-04-04' as date) - 30 days)
                    and (cast ('2001-04-04' as date) + 30 days)
...
select  i_item_id
 ...
 and d_date between cast('2000-02-20' as date) and (cast('2000-02-20' as date) +  60 days)
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('1999-04-25' as date) and (cast('1999-04-25' as date) +  60 days)
...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('2001-08-28' as date) 
                  and (cast('2001-08-28' as date) +  14 days)
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2001-01-25','2001-09-13','2001-11-16')))
...
with ss as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2002-08-28' as date) 
                  and (cast('2002-08-28' as date) +  30 days) 
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
