...
select  i_item_id
 ...
 and d_date between cast('1999-03-25' as date) and (cast('1999-03-25' as date) +  60 days)
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2002-04-18' as date) and (cast('2002-04-18' as date) +  60 days)
...
select  
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('1998-04-03' as date) - 30 days)
                and (cast ('1998-04-03' as date) + 30 days) 
 group by
    w_state,i_item_id
...
and d_date between '2002-03-16' and 
        (cast('2002-03-16' as date) + 90 days)
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2001-07-21','2001-08-13','2001-11-02')))
...
where 
	ws_item_sk = i_item_sk 
  	...
  	and ws_sold_date_sk = d_date_sk
	and d_date between cast('2000-04-09' as date) 
				and (cast('2000-04-09' as date) + 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
i_manufact_id = 459
and i_item_sk = cs_item_sk 
and d_date between '2001-03-24' and 
        (cast('2001-03-24' as date) + 90 days)
...
with ss as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2002-08-08' as date) 
                  and (cast('2002-08-08' as date) +  30 days) 
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
...
select  i_item_id
 ...
 and d_date between cast('2001-02-04' as date) 
 				and (cast('2001-02-04' as date) + 30 days)
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
