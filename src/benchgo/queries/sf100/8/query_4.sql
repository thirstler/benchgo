...
select  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between (cast ('1998-03-16' as date) - 30 days)
                    and (cast ('1998-03-16' as date) + 30 days)
...
select  i_item_id
 ...
 and d_date between cast('1999-05-29' as date) and (cast('1999-05-29' as date) +  60 days)
...
and d_date between '2001-03-08' and 
        (cast('2001-03-08' as date) + 90 days)
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('1999-06-14' as date) and (cast('1999-06-14' as date) +  60 days)
...
where 
	...
	and d_date between cast('2000-01-13' as date) 
				and (cast('2000-01-13' as date) + 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select  i_item_id
 ...
 and d_date between cast('2001-04-10' as date) 
 				and (cast('2001-04-10' as date) + 30 days)
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('2001-08-05' as date) 
                  and (cast('2001-08-05' as date) +  14 days)
