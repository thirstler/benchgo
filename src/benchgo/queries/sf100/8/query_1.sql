...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('1999-03-04','1999-10-08','1999-11-06')))
...
and d_date between '2000-02-20' and 
        (cast('2000-02-20' as date) + 90 days)
...
and d_date between '1998-03-26' and 
        (cast('1998-03-26' as date) + 90 days)
...
where 
	...
	and d_date between cast('2002-05-18' as date) 
...
select  
   w_state
  ,i_item_id
  ,sum(case when (cast(d_date as date) < cast ('1999-05-09' as date)) 
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('1999-05-09' as date) - 30 days)
                and (cast ('1999-05-09' as date) + 30 days) 
 group by
    w_state,i_item_id
...
where 
	ws_item_sk = i_item_sk 
  	...
  	and ws_sold_date_sk = d_date_sk
	and d_date between cast('2000-03-09' as date) 
...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('2000-08-16' as date) 
                  and (cast('2000-08-16' as date) +  14 days)
...
select  i_item_id
 ...
 and d_date between cast('2001-02-05' as date) and (cast('2001-02-05' as date) +  60 days)
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2002-04-29' as date) and (cast('2002-04-29' as date) +  60 days)
...
with ssr as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2002-08-12' as date) 
                  and (cast('2002-08-12' as date) +  30 days)
       and ss_store_sk = s_store_sk
       and ss_item_sk = i_item_sk
...
select  i_item_id
 ...
 where cs_item_sk = i_item_sk 
   ...
   and cs_sold_date_sk = d_date_sk
 and d_date between cast('1999-06-12' as date) 
