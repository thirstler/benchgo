...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('1999-07-06','1999-08-29','1999-11-22')))
...
and d_date between '2002-01-10' and 
        (cast('2002-01-10' as date) + 90 days)
...
where 
	...
	and d_date between cast('2000-02-24' as date) 
				and (cast('2000-02-24' as date) + 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select  
   w_state
  ,i_item_id
  ,sum(case when (cast(d_date as date) < cast ('2000-07-01' as date)) 
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('2000-07-01' as date) - 30 days)
                and (cast ('2000-07-01' as date) + 30 days) 
 group by
    w_state,i_item_id
...
where 
	...
	and d_date between cast('2001-04-24' as date) 
				and (cast('2001-04-24' as date) + 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('1999-08-11' as date) 
                  and (cast('1999-08-11' as date) +  14 days)
...
select  i_item_id
 ...
 and d_date between cast('2001-01-23' as date) and (cast('2001-01-23' as date) +  60 days)
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2002-06-14' as date) and (cast('2002-06-14' as date) +  60 days)
...
with ssr as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('1999-08-09' as date) 
                  and (cast('1999-08-09' as date) +  30 days)
       and ss_store_sk = s_store_sk
       and ss_item_sk = i_item_sk
...
select  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between (cast ('2002-03-12' as date) - 30 days)
                    and (cast ('2002-03-12' as date) + 30 days)
...
select  i_item_id
 ...
 and d_date between cast('2001-06-05' as date) 
 				and (cast('2001-06-05' as date) + 30 days)
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
