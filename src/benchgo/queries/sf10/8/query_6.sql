...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('2000-08-21' as date) 
                  and (cast('2000-08-21' as date) +  14 days)
...
and d_date between '1998-01-19' and 
        (cast('1998-01-19' as date) + 90 days)
...
select  i_item_id
 ...
 and d_date between cast('2002-03-12' as date) and (cast('2002-03-12' as date) +  60 days)
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('1998-05-27' as date) and (cast('1998-05-27' as date) +  60 days)
...
select  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between (cast ('2002-02-25' as date) - 30 days)
                    and (cast ('2002-02-25' as date) + 30 days)
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2001-05-26','2001-09-10','2001-11-05')))
...
i_manufact_id = 26
and i_item_sk = ws_item_sk 
and d_date between '1999-01-09' and 
        (cast('1999-01-09' as date) + 90 days)
...
where 
	...
	and d_date between cast('2001-04-16' as date) 
				and (cast('2001-04-16' as date) + 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select  
   w_state
  ,i_item_id
  ,sum(case when (cast(d_date as date) < cast ('2001-05-10' as date)) 
 ...
 and cs_warehouse_sk    = w_warehouse_sk 
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('2001-05-10' as date) - 30 days)
                and (cast ('2001-05-10' as date) + 30 days) 
 group by
    w_state,i_item_id
