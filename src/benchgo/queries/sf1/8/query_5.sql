...
select  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between (cast ('1998-06-05' as date) - 30 days)
                    and (cast ('1998-06-05' as date) + 30 days)
...
with ss as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('1999-08-20' as date) 
                  and (cast('1999-08-20' as date) +  30 days) 
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
...
and d_date between '2000-01-11' and 
        (cast('2000-01-11' as date) + 90 days)
...
and d_date between '2002-03-25' and 
        (cast('2002-03-25' as date) + 90 days)
...
select  
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('2001-06-24' as date) - 30 days)
                and (cast ('2001-06-24' as date) + 30 days) 
 group by
    w_state,i_item_id
...
select  i_item_id
 ...
 and d_date between cast('2001-05-16' as date) 
 				and (cast('2001-05-16' as date) + 30 days)
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('1998-08-21' as date) 
                  and (cast('1998-08-21' as date) +  14 days)
...
where 
	...
	and d_date between cast('2001-04-27' as date) 
				and (cast('2001-04-27' as date) + 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select  i_item_id
 ...
 and d_date between cast('2002-01-18' as date) and (cast('2002-01-18' as date) +  60 days)
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2000-06-24' as date) and (cast('2000-06-24' as date) +  60 days)
