...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('2001-08-11' as date) 
                  and (cast('2001-08-11' as date) +  14 days)
...
with ss as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2002-08-17' as date) 
                  and (cast('2002-08-17' as date) +  30 days) 
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
...
select  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between (cast ('1999-05-04' as date) - 30 days)
                    and (cast ('1999-05-04' as date) + 30 days)
...
select  
 ...
 and cs_warehouse_sk    = w_warehouse_sk 
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('2001-02-24' as date) - 30 days)
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2002-03-22' as date) and (cast('2002-03-22' as date) +  60 days)
...
select  i_item_id
 ...
 and d_date between cast('2001-04-06' as date) 
 				and (cast('2001-04-06' as date) + 30 days)
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
and d_date between '1998-01-17' and 
        (cast('1998-01-17' as date) + 90 days)
...
and d_date between '1998-03-24' and 
        (cast('1998-03-24' as date) + 90 days)
