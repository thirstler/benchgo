...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Fairfield County','Luce County','Ziebach County','Richland County',
...
select  i_item_id
 ...
 where cs_item_sk = i_item_sk 
   ...
   and cs_sold_date_sk = d_date_sk
 and d_date between cast(date('2000-03-28') as date) 
 				and (cast(date('2000-03-28') as date) + interval '30' day)
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Williamson County','Franklin Parish','Daviess County','Luce County')
...
with ssr as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast(date('1999-08-24') as date) 
                  and (cast(date('1999-08-24') as date) + interval '30' day)
       and ss_store_sk = s_store_sk
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 3266377
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 4252231
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 1967703
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 1985922
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 1568274
            then (select avg(ss_ext_tax)
                  from store_sales
...
and d_date between date(date('1998-02-09')) and 
        (cast(date('1998-02-09') as date) + interval '90' day)
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2000) and
        ((i_category in ('Sports','Shoes','Home') and
          i_class in ('tennis','womens','wallpaper')
         )
      or (i_category in ('Children','Women','Books') and
          i_class in ('infants','dresses','romance') 
        ))
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 18 and 18+10
          or ss_coupon_amt between 15319 and 15319+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 87 and 87+10
          or ss_coupon_amt between 8676 and 8676+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 154 and 154+10
          or ss_coupon_amt between 9416 and 9416+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 153 and 153+10
          or ss_coupon_amt between 10343 and 10343+1000
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (12,1,3,4,6,11) and
       d_year = 2000 and
       ca_state in ('IL','TX','OH'
                   ,'SC','NE','AK','SD')
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Bunker Hill'
   ...
   and ib_lower_bound   >=  33272
   and ib_upper_bound   <=  33272 + 50000
...
select  i_item_id
 ...
 and d_date between cast(date('1998-04-08') as date) and (cast(date('1998-04-08') as date) + interval '60' day)
 and i_manufact_id in (338,923,815,819)
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '46558','83854','49035','74180','73768','16436',
                          '25079','68951','75564','73795','73164',
                          '75531','91465','46740','59252','68307',
                          '85911','58468','58599','25719','82695',
                          '16033','27365','44790','78203','12804',
                          '36746','83099','74523','73112','60457',
                          '75853','98775','17619','50321','52650',
                          '44832','95960','92655','63185','62552',
                          '71370','15658','56478','19018','40169',
                          '66489','57116','77343','13149','23832',
                          '40168','98488','60075','44420','33924',
                          '38628','26722','84662','41962','11848',
                          '13952','89214','56061','99636','30963',
                          '85056','47552','95529','11929','75903',
                          '45448','52417','74916','39022','58294',
                          '73996','83463','59219','50598','41882',
                          '63299','69857','86174','24134','24517',
                          '69688','88984','24216','12715','56057',
                          '83822','38322','23579','58627','20485',
                          '14809','33914','13720','18448','55004',
                          '66995','46507','16370','53202','12762',
                          '39948','28165','95706','85742','78707',
                          '66380','39275','50288','79841','92817',
                          '54733','57612','67312','74289','48266',
                          '78755','90787','82620','86511','89311',
                          '75960','66507','41745','51990','51808',
                          '78644','26702','29919','32007','10978',
                          '64502','20628','17518','45930','30861',
                          '94509','88637','90428','30765','30566',
                          '98762','74521','56081','22069','94500',
                          '47871','75447','70470','53461','98087',
                          '19811','76511','20805','92336','88646',
                          '50227','73469','66045','81062','83583',
                          '83874','52982','39503','91164','77160',
                          '26964','85431','13778','96975','11586',
                          '54844','32509','43847','21369','22633',
                          '16955','86431','45056','23232','42003',
                          '85938','88273','32183','32125','52115',
                          '64279','96529','41256','18054','91292',
                          '58433','55879','99846','73673','63412',
                          '79863','70705','51382','97451','20378',
                          '43599','31063','11019','67375','78721',
                          '76445','56681','16414','97697','28929',
                          '61416','45094','24019','71509','73222',
                          '37810','23547','53759','63440','56826',
                          '50865','90830','96396','71796','99522',
                          '54548','60665','19433','49017','24523',
                          '40700','73034','43818','51201','21146',
                          '20718','51242','95089','32651','66564',
                          '55486','79390','96077','48756','78860',
                          '80298','29291','33437','16865','24606',
                          '73847','89957','60599','88006','59942',
                          '35730','62267','41710','95684','95197',
                          '90198','65502','63723','61510','15677',
                          '76529','59666','20386','59921','19806',
                          '80701','14209','14925','61373','90222',
                          '31336','59796','17072','14546','49161',
                          '42545','57237','77010','73504','46088',
                          '46408','62666','10070','78870','73800',
                          '90003','63770','83094','48902','63807',
                          '63724','73388','66832','64755','11552',
                          '95250','54144','71963','86944','16367',
                          '86341','32389','39062','73650','65897',
                          '42085','66135','69687','22172','40456',
                          '11460','58993','33567','42704','66603',
                          '64524','23446','38862','52263','12106',
                          '84859','76369','92565','24564','19469',
                          '92678','15245','10463','94322','34767',
                          '26119','37403','90345','70245','91144',
                          '73466','20573','43227','58372','67951',
                          '30293','59142','34992','46348','13715',
                          '59754','32407','39360','94626','29416',
                          '83431','39338','14507','76043','78507',
                          '84781','13184','96323','34922','21101',
                          '40794','29803','39817','49426','22608',
                          '76875','85507','64011','36378','79478',
                          '24258','71626','18193','16833','16560',
                          '54684','32587','31416','83401','32813',
                          '61866','65661','56688','62445','53048',
                          '29820','70184','61631','20588')
     intersect
      select ca_zip
 ...
 where i_manufact_id between 671 and 671+40 
   and (select count(*) as item_cnt
       ...
       (i_manufact = i1.i_manufact and
        ...
        (i_category = 'Men' and
        (i_color = 'orchid' or i_color = 'metallic') and
...
with ss as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast(date('2002-08-22') as date) 
                  and (cast(date('2002-08-22') as date) + interval '30' day) 
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
...
where 
	ss_item_sk = i_item_sk 
  	...
  	and ss_sold_date_sk = d_date_sk
	and d_date between cast(date('2002-01-16') as date) 
				and (cast(date('2002-01-16') as date) + interval '30' day)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('chartreuse','wheat','black'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 1998
 and     d_moy                   = 6
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast(date('2000-01-23') as date) and (cast(date('2000-01-23') as date) + interval '60' day)
 and i_manufact_id in (732,912,685,928)
 and inv_quantity_on_hand between 100 and 500
 and cs_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Plumas County','Renville County','Mecosta County','Culpeper County','Newport News city') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
select  *
 from(select w_warehouse_name
            ,i_item_id
            ,sum(case when (cast(d_date as date) < cast (date('2000-05-26') as date))
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between (cast (date('2000-05-26') as date) - interval '30' day)
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and date_dim.d_year in (2000,2000+1,2000+2) 
    and store.s_city in ('Pleasant Hill','Midway','Union','Pleasant Valley','Centerville') 
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in (date('2000-06-07'),date('2000-08-26'),date('2000-11-16'))))
...
i_manufact_id = 320
and i_item_sk = ws_item_sk 
and d_date between date(date('2002-01-27')) and 
        (cast(date('2002-01-27') as date) + interval '90' day)
...
where 
	ws_item_sk = i_item_sk 
  	...
  	and ws_sold_date_sk = d_date_sk
	and d_date between cast(date('1999-03-22') as date) 
				and (cast(date('1999-03-22') as date) + interval '30' day)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('lemon','chocolate','sienna','misty','tan','khaki') and
...
select   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2000
 	and t_time between 15101 and 15101+28800 
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('IN', 'TN', 'OR')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('TX', 'PA', 'MO')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('ME', 'NJ', 'KY')
...
select  
   w_state
  ,i_item_id
  ,sum(case when (cast(d_date as date) < cast (date('2001-02-26') as date)) 
 ...
 and cs_warehouse_sk    = w_warehouse_sk 
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast (date('2001-02-26') as date) - interval '30' day)
                and (cast (date('2001-02-26') as date) + interval '30' day) 
 group by
    w_state,i_item_id
...
and cc_county in ('Fairfield County','Richland County','Daviess County','Barrow County',
                  'Franklin Parish'
)
and exists (select *
