...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2001) and
        ((i_category in ('Home','Shoes','Men') and
          i_class in ('glassware','athletic','accessories')
         )
      or (i_category in ('Music','Books','Electronics') and
          i_class in ('classical','reference','camcorders') 
        ))
...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast(date('2001-08-09') as date) 
                  and (cast(date('2001-08-09') as date) + interval '14' day)
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (2,6,9,8,11,10) and
       d_year = 1998 and
       ca_state in ('WI','GA','MN'
                   ,'MI','TX','NH','IN')
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('blush','grey','sienna'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2002
 and     d_moy                   = 5
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('AK', 'OK', 'TX')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('OH', 'VA', 'TN')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('KY', 'ND', 'LA')
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Shiloh'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  60570
   and ib_upper_bound   <=  60570 + 50000
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Sutter County','Box Butte County','Webb County','Camden County','Harding County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
from
  ...
  ,web_site
where
    d_date between date(date('2002-3-01')) and 
           (cast(date('2002-3-01') as date) + interval '60' day)
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '63320','30911','48658','80057','12322','57767',
                          '93200','54520','50150','14790','25770',
                          '91394','86929','41886','23513','66016',
                          '92320','12242','65141','18069','13289',
                          '25204','90756','66443','42089','39192',
                          '60979','53578','30324','37435','94219',
                          '26269','11862','70748','98576','92779',
                          '54592','72873','95612','97583','96183',
                          '54698','48803','45726','35852','29872',
                          '44639','96761','84458','71502','84198',
                          '13086','91005','50554','70111','18584',
                          '76519','15174','89333','71791','63495',
                          '62795','65090','97731','13083','52894',
                          '74004','28784','37463','80726','63948',
                          '14665','14655','19848','16215','24348',
                          '59834','49571','55284','58451','74963',
                          '85871','76564','68256','30806','12679',
                          '27268','45887','72047','78406','26863',
                          '27126','23125','71275','30595','54460',
                          '74326','17861','36288','45714','70453',
                          '75101','71240','96289','99501','99160',
                          '42113','68218','29232','49531','22111',
                          '33778','68853','61925','72476','83543',
                          '61331','69326','41247','84331','70628',
                          '95548','15024','41778','22388','46092',
                          '30073','60519','91611','55568','51358',
                          '10791','84898','55370','98441','25521',
                          '18064','21813','42786','53192','14094',
                          '39444','96906','17795','33833','79446',
                          '19637','49787','50206','59043','68307',
                          '62188','21851','55670','31504','19192',
                          '68381','13836','72947','13005','21578',
                          '21668','90163','84166','43975','27553',
                          '12543','36603','12119','67664','29234',
                          '24609','52129','32555','53947','55343',
                          '55101','69083','33477','70764','55864',
                          '28560','22090','26391','30562','92066',
                          '67869','95913','16868','22668','21580',
                          '40520','17661','33365','93586','20175',
                          '99566','37672','92608','96219','76132',
                          '93908','40481','69401','24686','59263',
                          '82745','13378','38298','84839','52213',
                          '10833','45005','58585','47007','10466',
                          '41082','74502','57931','72607','43220',
                          '99300','30187','16049','80939','50582',
                          '91852','49264','14309','49909','57049',
                          '86314','24798','81164','52405','79341',
                          '48085','60940','32478','97889','76659',
                          '41738','14944','49532','24617','41547',
                          '86505','54053','73845','55756','46296',
                          '34280','86219','14433','23727','59959',
                          '59673','37482','61608','47622','70745',
                          '79384','55611','13617','55148','58112',
                          '60996','73238','48272','54502','86990',
                          '73698','87452','19876','74737','34425',
                          '95307','92650','39584','40306','76858',
                          '67377','90125','72765','88824','27143',
                          '55422','24650','19855','31348','51043',
                          '24440','89690','74730','95736','87472',
                          '14632','88180','29317','56966','61196',
                          '56351','29032','43836','29121','22020',
                          '47606','29574','93786','94099','41493',
                          '18232','41246','40817','12421','11720',
                          '28827','72239','43969','30436','72789',
                          '29507','71268','61637','12086','70302',
                          '15781','14998','64291','52283','42874',
                          '31401','53347','40943','43579','81383',
                          '18619','84581','49343','71144','40577',
                          '32841','17908','20392','29047','10876',
                          '18296','44671','96663','67922','66558',
                          '28907','15443','66079','30483','69451',
                          '42665','64555','48219','68550','98615',
                          '56403','24128','17964','39731','52607',
                          '76163','34774','60108','26714','27189',
                          '27747','23309','14207','55115','30221',
                          '54500','40183','24961','59464','89957',
                          '24342','87020','15367','81610','71266',
                          '80851','87225','46348','12627','17680',
                          '42300','52114','62887','60892','58481',
                          '15986','53056','46644','91060')
     intersect
      select ca_zip
...
select  i_item_id
 ...
 and d_date between cast(date('1999-06-18') as date) and (cast(date('1999-06-18') as date) + interval '60' day)
 and i_manufact_id in (843,975,848,685)
...
select   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2001
 	and t_time between 34873 and 34873+28800 
...
select  *
 from(select w_warehouse_name
            ,i_item_id
            ,sum(case when (cast(d_date as date) < cast (date('2000-03-25') as date))
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between (cast (date('2000-03-25') as date) - interval '30' day)
                    and (cast (date('2000-03-25') as date) + interval '30' day)
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast(date('2000-02-07') as date) and (cast(date('2000-02-07') as date) + interval '60' day)
 and i_manufact_id in (928,894,956,137)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Walnut Grove','Glendale','Mount Zion','Sunnyside','Bethel') 
...
select  
   w_state
  ,i_item_id
  ,sum(case when (cast(d_date as date) < cast (date('1999-02-02') as date)) 
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast (date('1999-02-02') as date) - interval '30' day)
                and (cast (date('1999-02-02') as date) + interval '30' day) 
 group by
    w_state,i_item_id
...
and cc_county in ('Jefferson Davis Parish','Bronx County','Richland County','Wadena County',
                  'Pennington County'
)
and exists (select *
...
i_manufact_id = 595
and i_item_sk = ws_item_sk 
and d_date between date(date('2001-02-25')) and 
        (cast(date('2001-02-25') as date) + interval '90' day)
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Jackson County','Huron County','Jefferson Davis Parish','Daviess County',
                           'San Miguel County','Bronx County','Pennington County','Wadena County')
...
select  c_last_name
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and date_dim.d_year in (2000,2000+1,2000+2)
        and store.s_city in ('Highland','Mount Vernon')
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in (date('2001-01-28'),date('2001-09-14'),date('2001-11-19'))))
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 76 and 76+10 
             or ss_coupon_amt between 10843 and 10843+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 92 and 92+10
          or ss_coupon_amt between 76 and 76+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 147 and 147+10
          or ss_coupon_amt between 12709 and 12709+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 134 and 134+10
          or ss_coupon_amt between 11171 and 11171+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 183 and 183+10
          or ss_coupon_amt between 11118 and 11118+1000
...
where 
	ws_item_sk = i_item_sk 
  	and i_category in ('Home', 'Sports', 'Books')
  	and ws_sold_date_sk = d_date_sk
	and d_date between cast(date('1999-03-04') as date) 
				and (cast(date('1999-03-04') as date) + interval '30' day)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('lavender','purple','smoke','indian','blanched','red') and
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 2309080
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 10108210
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 16639068
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 16167673
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 44412930
            then (select avg(ss_ext_discount_amt)
                  from store_sales
...
i_manufact_id = 261
and i_item_sk = cs_item_sk 
and d_date between date(date('2001-03-31')) and 
        (cast(date('2001-03-31') as date) + interval '90' day)
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1999,1999+1,1999+2)
    and store.s_county in ('Mesa County','San Miguel County','Raleigh County','Bronx County')
...
with ss as
 ...
 from store_sales,
      ...
      store
 where ss_sold_date_sk = d_date_sk
       and d_date between cast(date('1998-08-25') as date) 
                  and (cast(date('1998-08-25') as date) + interval '30' day) 
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
...
select  i_item_id
 ...
 where cs_item_sk = i_item_sk 
   ...
   and cs_sold_date_sk = d_date_sk
 and d_date between cast(date('1999-02-14') as date) 
 				and (cast(date('1999-02-14') as date) + interval '30' day)
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
