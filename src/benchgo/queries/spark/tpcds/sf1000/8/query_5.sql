...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Pennington County','Oglethorpe County','Mobile County','San Miguel County')
...
select   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2001
 	and t_time between 525 and 525+28800 
...
where 
	ss_item_sk = i_item_sk 
  	...
  	and ss_sold_date_sk = d_date_sk
	and d_date between cast(date('2001-06-17') as date) 
				and (cast(date('2001-06-17') as date) + interval '30' day)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('MI', 'PA', 'CO')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('SD', 'OH', 'MO')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('ID', 'GA', 'KS')
...
select  *
 from(select w_warehouse_name
            ,i_item_id
            ,sum(case when (cast(d_date as date) < cast (date('1999-02-12') as date))
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between (cast (date('1999-02-12') as date) - interval '30' day)
                    and (cast (date('1999-02-12') as date) + interval '30' day)
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('linen','chartreuse','metallic'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2002
 and     d_moy                   = 1
...
and d_date between date(date('2000-03-13')) and 
        (cast(date('2000-03-13') as date) + interval '90' day)
...
select  c_last_name
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and store.s_city in ('Hopewell','Centerville')
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 43 and 43+10 
             or ss_coupon_amt between 7616 and 7616+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 72 and 72+10
          or ss_coupon_amt between 582 and 582+1000
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (1,9,11,12,7,2) and
       d_year = 2001 and
       ca_state in ('LA','IA','MN'
                   ,'ID','MI','TX','CO')
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '33844','85909','11183','50531','53855','34786',
                          '82250','18317','60929','29025','56425',
                          '73694','26578','28228','66637','32375',
                          '81879','62970','10086','11911','89718',
                          '72407','14934','89301','73602','28356',
                          '76582','93029','74392','91900','59048',
                          '59149','90790','96780','50820','10713',
                          '34843','30973','90443','59916','73349',
                          '89234','64440','61184','94842','45381',
                          '67235','13933','88197','13272','10823',
                          '26491','83105','32501','85094','83028',
                          '98786','94606','63899','58508','70388',
                          '41956','95736','71559','89355','95511',
                          '44245','98086','71653','33405','27384',
                          '33139','28050','81712','55661','36130',
                          '13855','25217','99474','54381','95504',
                          '20759','19377','49534','41657','93259',
                          '76755','36336','35502','68426','98059',
                          '15515','17078','22752','28493','54260',
                          '89291','41273','60766','53189','85637',
                          '68455','61297','65836','62200','28219',
                          '22661','52381','67297','62698','18272',
                          '99921','10753','68219','61265','16671',
                          '13297','18305','76522','26638','75213',
                          '35111','98272','66521','68507','93731',
                          '32664','71302','99031','81537','78748',
                          '94075','55933','41343','90564','95767',
                          '85613','61149','45851','44096','90448',
                          '97482','91321','91214','28174','10941',
                          '99683','67670','15241','74695','31031',
                          '88368','93027','29606','87106','25588',
                          '36298','50407','83011','30221','59560',
                          '79021','54342','16440','50558','86457',
                          '68786','48586','31521','92426','12532',
                          '45193','87246','34165','23198','43245',
                          '76202','98931','67479','32340','37247',
                          '20570','80615','83698','68888','99688',
                          '55426','46618','79104','60204','28269',
                          '21080','75584','31221','67126','53926',
                          '95081','21801','13492','86615','95775',
                          '47297','54721','94324','92469','40175',
                          '87136','57929','68983','42242','14176',
                          '48035','52834','15520','97410','94706',
                          '90560','18271','41424','33397','40957',
                          '94211','49993','91230','26045','62951',
                          '12032','30754','42494','93111','21446',
                          '81221','83053','97968','11406','76611',
                          '37786','33400','40267','38800','86061',
                          '46698','41337','27316','37636','85316',
                          '55883','35873','67649','85121','30729',
                          '81916','77515','93240','61345','27059',
                          '12104','47434','39950','75191','90643',
                          '15403','25789','92780','89067','81257',
                          '48230','83758','20305','78313','47304',
                          '83824','77025','12782','49686','11735',
                          '45667','69296','91301','28358','68961',
                          '58040','89647','45849','32063','28857',
                          '61731','43610','80650','36567','25558',
                          '81163','77075','38748','77865','52091',
                          '10564','62416','11031','78912','15373',
                          '35656','29373','99518','20982','92239',
                          '66280','59648','35248','39602','25115',
                          '91213','85394','70907','97831','95130',
                          '74182','10124','41005','37233','17147',
                          '63862','13357','16376','91809','91658',
                          '64098','73183','98098','24534','88704',
                          '45938','33876','88050','65623','18379',
                          '48455','59213','31500','31529','34129',
                          '77424','59468','68672','64385','37286',
                          '66993','34644','75239','38430','39927',
                          '11740','75903','19223','11626','54293',
                          '48151','52266','31766','67368','80105',
                          '10623','17982','39980','32586','55374',
                          '90710','95477','51284','57695','16314',
                          '31608','70977','24383','91966','90688',
                          '37609','45125','25325','94866','59331',
                          '50787','66803','51717','99083','63497',
                          '32353','54046','95119','31809','35398',
                          '47082','59320','48837','28960','79189',
                          '65557','27875','33462','35974')
     intersect
      select ca_zip
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1998,1998+1,1998+2) 
    and store.s_city in ('Antioch','New Hope','Glenwood','Salem','Cedar Grove') 
...
and d_date between date(date('2000-02-14')) and 
        (cast(date('2000-02-14') as date) + interval '90' day)
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Unionville'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  57235
   and ib_upper_bound   <=  57235 + 50000
...
where ss_item_sk = i_item_sk and
      ...
      ss_store_sk = s_store_sk and
      d_year in (1998) and
        ((i_category in ('Children','Women','Home') and
          i_class in ('school-uniforms','dresses','furniture')
         )
      or (i_category in ('Music','Men','Shoes') and
          i_class in ('rock','shirts','womens') 
        ))
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in (date('1998-07-02'),date('1998-08-20'),date('1998-11-13'))))
...
select  
   w_state
  ,i_item_id
  ,sum(case when (cast(d_date as date) < cast (date('1998-05-20') as date)) 
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast (date('1998-05-20') as date) - interval '30' day)
                and (cast (date('1998-05-20') as date) + interval '30' day) 
 group by
    w_state,i_item_id
...
and cc_county in ('Ziebach County','Dauphin County','Bronx County','Barrow County',
                  'Marshall County'
)
and exists (select *
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('firebrick','forest','powder','sandy','magenta','honeydew') and
...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast(date('1999-08-29') as date) 
                  and (cast(date('1999-08-29') as date) + interval '14' day)
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Fannin County','Northumberland County','Jackson County','Anderson County','Butler County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
where 
	ws_item_sk = i_item_sk 
  	...
  	and ws_sold_date_sk = d_date_sk
	and d_date between cast(date('1998-01-17') as date) 
				and (cast(date('1998-01-17') as date) + interval '30' day)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select  i_item_id
 ...
 and i_manufact_id in (956,698,871,982)
...
select  distinct(i_product_name)
 ...
 where i_manufact_id between 841 and 841+40 
   and (select count(*) as item_cnt
        ...
        (i_category = 'Women' and
        (i_color = 'midnight' or i_color = 'magenta') and
       ...
       (i_manufact = i1.i_manufact and
        ...
        (i_category = 'Women' and
        (i_color = 'cream' or i_color = 'goldenrod') and
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 38656018
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 16999207
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 11489781
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 41496758
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 34796011
            then (select avg(ss_ext_sales_price)
                  from store_sales
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (2000,2000+1,2000+2)
    and store.s_county in ('Franklin Parish','Walker County','Dauphin County','Barrow County',
                           'Kittitas County','Fairfield County','Maverick County','Richland County')
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast(date('2000-04-05') as date) and (cast(date('2000-04-05') as date) + interval '60' day)
 and i_manufact_id in (694,691,750,916)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
