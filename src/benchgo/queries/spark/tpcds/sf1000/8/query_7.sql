...
and d_date between date(date('1999-03-14')) and 
        (cast(date('1999-03-14') as date) + interval '90' day)
...
and d_date between date(date('2002-02-13')) and 
        (cast(date('2002-02-13') as date) + interval '90' day)
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('orange','plum','tomato','ghost','chiffon','spring') and
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Wadena County','San Miguel County','Daviess County','Gogebic County',
                           'Raleigh County','Bronx County','Fairfield County','Mobile County')
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('GA', 'NE', 'MO')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('MS', 'MN', 'LA')
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 113 and 113+10 
             or ss_coupon_amt between 12567 and 12567+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 14 and 14+10
          or ss_coupon_amt between 15468 and 15468+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 156 and 156+10
          or ss_coupon_amt between 8582 and 8582+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 87 and 87+10
          or ss_coupon_amt between 11868 and 11868+1000
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Summit'
   ...
   and ib_lower_bound   >=  64441
   and ib_upper_bound   <=  64441 + 50000
...
where 
	ss_item_sk = i_item_sk 
  	...
  	and ss_sold_date_sk = d_date_sk
	and d_date between cast(date('1999-03-08') as date) 
				and (cast(date('1999-03-08') as date) + interval '30' day)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
with ssr as
 (select  s_store_id as store_id,
  ...
  from store_sales left outer join store_returns on
     ...
     promotion
 where ss_sold_date_sk = d_date_sk
       and d_date between cast(date('1998-08-23') as date) 
                  and (cast(date('1998-08-23') as date) + interval '30' day)
...
select  i_item_id
 ...
 where cs_item_sk = i_item_sk 
   ...
   and cs_sold_date_sk = d_date_sk
 and d_date between cast(date('2001-01-24') as date) 
 				and (cast(date('2001-01-24') as date) + interval '30' day)
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1999,1999+1,1999+2) 
    and store.s_city in ('Woodlawn','Cedar Grove','Springfield','Greenwood','Glendale') 
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Walsh County','Pawnee County','LaMoure County','Gaines County','Pulaski County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
select  i_item_id
 ...
 and d_date between cast(date('2002-05-01') as date) and (cast(date('2002-05-01') as date) + interval '60' day)
 and i_manufact_id in (919,740,818,688)
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 34064319
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 4575977
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 22339579
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 47372672
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 15384280
            then (select avg(ss_ext_sales_price)
                  from store_sales
...
select  
   w_state
  ,i_item_id
  ,sum(case when (cast(d_date as date) < cast (date('2002-02-26') as date)) 
 ...
 and cs_warehouse_sk    = w_warehouse_sk 
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast (date('2002-02-26') as date) - interval '30' day)
                and (cast (date('2002-02-26') as date) + interval '30' day) 
 group by
    w_state,i_item_id
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast(date('2001-06-19') as date) and (cast(date('2001-06-19') as date) + interval '60' day)
 and i_manufact_id in (515,482,850,156)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1999,1999+1,1999+2)
    and store.s_county in ('San Miguel County','Jefferson Davis Parish','Walker County','Mesa County')
...
where ss_item_sk = i_item_sk and
      ...
      ss_store_sk = s_store_sk and
      d_year in (2002) and
        ((i_category in ('Children','Sports','Men') and
          i_class in ('infants','sailing','shirts')
         )
      or (i_category in ('Books','Electronics','Jewelry') and
          i_class in ('business','audio','custom') 
        ))
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (5,11,2,12,6,9) and
       d_year = 2001 and
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('lemon','dim','khaki'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2000
 and     d_moy                   = 6
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in (date('1998-06-29'),date('1998-09-28'),date('1998-11-02'))))
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '22724','87573','35330','92699','23806','95716',
                          '59151','67984','65805','41259','50605',
                          '46764','11778','93617','66331','98603',
                          '71451','57593','79214','11620','29822',
                          '29016','59909','18025','40320','79400',
                          '77527','98837','45040','32200','73905',
                          '79617','23468','83760','28695','39181',
                          '19436','75952','41520','91422','28426',
                          '94313','79348','21508','74618','12458',
                          '60592','65615','52262','17546','13415',
                          '82607','19989','18548','47560','48017',
                          '62678','22885','91629','79781','87599',
                          '76772','53244','35153','87497','71832',
                          '87843','50480','23835','45527','99059',
                          '76597','12057','55384','70075','39326',
                          '86414','63330','62376','82315','55498',
                          '42143','34106','10969','97043','77608',
                          '23392','63195','41411','84389','22777',
                          '63002','58266','84702','85549','10447',
                          '48440','64189','54740','10569','97026',
                          '40587','55864','35996','57802','26891',
                          '53795','40522','31139','82011','32806',
                          '29103','99352','30636','78085','32492',
                          '18855','37103','65232','98220','15807',
                          '92193','22562','99453','92794','98191',
                          '40704','44165','27692','40922','46085',
                          '69738','97291','48880','69633','74443',
                          '32881','87744','23347','47846','23306',
                          '72594','71525','14156','51893','36943',
                          '51660','44509','54216','45627','57686',
                          '23780','36579','11274','55157','88161',
                          '44741','24165','85443','99052','30257',
                          '75281','71872','49586','96719','15655',
                          '43662','85812','96557','69802','33775',
                          '75031','33509','71776','72009','49870',
                          '67641','82616','12604','75407','62804',
                          '94897','36781','19873','44009','13945',
                          '20375','12574','94424','96663','30977',
                          '44806','96909','50797','94035','84096',
                          '28023','74294','54743','15336','42287',
                          '71222','31213','68385','82230','19446',
                          '48460','28377','24893','43108','25822',
                          '94997','19323','73377','79976','56623',
                          '14501','92656','30653','81515','99183',
                          '50666','82092','20324','72668','43901',
                          '67329','40040','75857','52360','62828',
                          '29188','63481','55234','12468','28707',
                          '61641','91981','66737','21130','37816',
                          '95600','38698','41214','49625','74690',
                          '66206','91466','12024','12732','29835',
                          '52091','30756','78040','63480','59237',
                          '79895','64132','94190','14773','22174',
                          '14495','57286','44549','77619','99647',
                          '72378','74269','66752','87760','32335',
                          '76071','69923','57603','28510','70711',
                          '76027','47914','79345','20062','66047',
                          '98959','41902','45920','17119','79169',
                          '60558','38940','10846','82384','95573',
                          '65681','18488','91088','54000','50749',
                          '61143','62080','35708','87313','92113',
                          '90040','71495','14608','75163','66792',
                          '72600','97253','35768','80226','93968',
                          '73986','69395','73740','78735','77593',
                          '89429','74614','88809','68308','90265',
                          '96561','43259','12392','95745','73907',
                          '58482','40449','58578','12750','72443',
                          '91002','36174','74026','96437','16629',
                          '86839','32872','83386','41682','27979',
                          '22974','64102','46239','89820','87015',
                          '15656','99144','76588','39509','53398',
                          '42111','44939','79465','19155','40307',
                          '89409','71712','42861','13995','78087',
                          '15436','75044','96582','88791','60295',
                          '83786','84841','54776','98237','59959',
                          '94418','90929','90626','37930','50644',
                          '46948','81591','15459','29414','24448',
                          '41891','11071','21769','25410','74114',
                          '16133','11284','99315','45305','13095',
                          '12426','45879','61252','71157','27099',
                          '93038','13362','60985','37003')
     intersect
      select ca_zip
...
where 
	ws_item_sk = i_item_sk 
  	...
  	and ws_sold_date_sk = d_date_sk
	and d_date between cast(date('2002-05-01') as date) 
				and (cast(date('2002-05-01') as date) + interval '30' day)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select  c_last_name
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and store.s_city in ('Lakeside','Riverside')
...
select   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 1998
 	and t_time between 38660 and 38660+28800 
...
with ss as
 ...
 from store_sales,
      ...
      store
 where ss_sold_date_sk = d_date_sk
       and d_date between cast(date('1998-08-16') as date) 
                  and (cast(date('1998-08-16') as date) + interval '30' day) 
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
...
and cc_county in ('Dauphin County','Richland County','Williamson County','Oglethorpe County',
                  'Ziebach County'
)
and exists (select *
