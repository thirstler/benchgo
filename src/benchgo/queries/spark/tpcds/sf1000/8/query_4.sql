...
and d_date between date(date('1998-03-09')) and 
        (cast(date('1998-03-09') as date) + interval '90' day)
...
select   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 1998
 	and t_time between 19916 and 19916+28800 
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'White Oak'
   ...
   and ib_lower_bound   >=  8433
   and ib_upper_bound   <=  8433 + 50000
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '98711','89860','57191','39622','32583','50098',
                          '58818','71973','71960','58753','11080',
                          '40821','83622','89172','88573','98334',
                          '23970','91768','65456','90141','12504',
                          '91400','19731','24776','31862','24674',
                          '73714','63550','63311','69481','96474',
                          '81002','27633','24644','56157','59605',
                          '36534','96344','21136','41873','15516',
                          '68974','65197','65701','30848','46504',
                          '77913','41980','92752','95303','96320',
                          '24802','22381','92511','30819','80039',
                          '51995','46103','76901','54274','27818',
                          '97933','55450','35100','66227','63433',
                          '54357','21218','81087','85832','89866',
                          '16569','68448','18326','72667','94128',
                          '13227','14166','66499','29816','48173',
                          '72800','50797','25825','45038','57171',
                          '14126','94941','85628','22536','35977',
                          '97730','11287','25017','85331','40978',
                          '22757','69601','77220','80226','89859',
                          '44302','93967','69332','18037','28344',
                          '15773','25617','17742','27502','71105',
                          '40591','93845','29539','79253','10529',
                          '55402','64132','96479','59400','58044',
                          '36820','94461','88716','70392','18223',
                          '16905','42137','56809','96337','81535',
                          '19109','70642','40725','32441','19353',
                          '64973','45008','52291','62400','58300',
                          '63889','50874','13925','48377','19864',
                          '33670','59838','96874','96789','26184',
                          '27912','58526','96947','51803','64573',
                          '28196','41380','17199','98184','10054',
                          '61387','54409','25436','14054','62057',
                          '52505','89855','78025','17277','77264',
                          '39593','56786','19916','59280','73272',
                          '24132','96084','13985','90643','76242',
                          '87596','93060','84405','75390','80949',
                          '36208','20858','22811','94510','16032',
                          '33405','93281','68807','81769','10797',
                          '44940','80567','49919','64016','23628',
                          '79612','32072','11392','84365','66894',
                          '50331','63502','95614','67586','56550',
                          '51849','31095','90628','46281','22397',
                          '84630','21838','79788','51485','48811',
                          '50141','77253','42436','88401','35906',
                          '15735','64486','52751','89297','69203',
                          '51519','11822','91425','15734','35625',
                          '12826','99977','27616','95749','52290',
                          '25645','93018','36980','14554','14220',
                          '97170','55537','87361','38628','97563',
                          '40054','82499','14753','46019','70868',
                          '74343','89565','85861','33880','30939',
                          '63932','67750','19319','32670','79645',
                          '26817','39877','90379','92274','14353',
                          '20370','16634','42858','58130','69987',
                          '25394','16282','11674','22744','78488',
                          '21700','15080','70002','35110','27244',
                          '66164','67033','71458','72433','39880',
                          '23537','46035','17188','47190','22040',
                          '25053','34605','58382','61267','15462',
                          '85782','26680','78186','25217','12257',
                          '49066','82789','61765','33827','33457',
                          '88687','75270','22820','37968','52844',
                          '16872','54790','80224','97390','47370',
                          '10163','16306','79602','86657','91676',
                          '88099','45560','58134','53362','86979',
                          '57943','99407','18171','78249','66512',
                          '44831','48000','42704','30574','36750',
                          '91959','58301','96545','73630','43994',
                          '36447','35340','70760','22361','80000',
                          '31706','91999','15330','97281','92915',
                          '12233','90512','57987','51322','77133',
                          '56376','73559','44131','60342','29193',
                          '73895','98867','78144','61409','95443',
                          '92789','77860','94086','22346','15422',
                          '61104','66450','95083','88163','17685',
                          '70507','88976','54376','42028','27020',
                          '56914','81290','91291','52941','78864',
                          '77809','74251','39098','18141','99301',
                          '47111','55117','68567','92256')
     intersect
      select ca_zip
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2001) and
        ((i_category in ('Jewelry','Books','Home') and
          i_class in ('estate','travel','paint')
         )
      or (i_category in ('Electronics','Children','Men') and
          i_class in ('monitors','infants','accessories') 
        ))
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and date_dim.d_year in (2000,2000+1,2000+2) 
    and store.s_city in ('Georgetown','Shiloh','Spring Valley','Lakeside','Mount Pleasant') 
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in (date('2001-03-18'),date('2001-09-04'),date('2001-11-19'))))
...
select  *
 from(select w_warehouse_name
            ,i_item_id
            ,sum(case when (cast(d_date as date) < cast (date('2002-03-27') as date))
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between (cast (date('2002-03-27') as date) - interval '30' day)
                    and (cast (date('2002-03-27') as date) + interval '30' day)
...
select  
   w_state
  ,i_item_id
  ,sum(case when (cast(d_date as date) < cast (date('1999-05-29') as date)) 
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast (date('1999-05-29') as date) - interval '30' day)
                and (cast (date('1999-05-29') as date) + interval '30' day) 
 group by
    w_state,i_item_id
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 177 and 177+10 
             or ss_coupon_amt between 17197 and 17197+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 106 and 106+10
          or ss_coupon_amt between 7422 and 7422+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 161 and 161+10
          or ss_coupon_amt between 5053 and 5053+1000
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (6,3,9,11,8,7) and
       d_year = 2000 and
       ca_state in ('ID','IL','IN'
                   ,'OK','MI','NE','GA')
...
select  i_item_id
 ...
 and d_date between cast(date('1999-03-06') as date) and (cast(date('1999-03-06') as date) + interval '60' day)
 and i_manufact_id in (918,783,901,753)
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Utah County','Lake County','McCook County','Calhoun County','Delaware County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
and d_date between date(date('2001-01-18')) and 
        (cast(date('2001-01-18') as date) + interval '90' day)
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast(date('2002-04-30') as date) and (cast(date('2002-04-30') as date) + interval '60' day)
 and i_manufact_id in (886,316,900,907)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
with ssr as
 (select  s_store_id as store_id,
  ...
  from store_sales left outer join store_returns on
     ...
     promotion
 where ss_sold_date_sk = d_date_sk
       and d_date between cast(date('2000-08-25') as date) 
                  and (cast(date('2000-08-25') as date) + interval '30' day)
       and ss_store_sk = s_store_sk
       and ss_item_sk = i_item_sk
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('chocolate','floral','olive'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2002
 and     d_moy                   = 7
...
select  c_last_name
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and store.s_city in ('Lakeview','Wildwood')
...
where 
	ws_item_sk = i_item_sk 
  	...
  	and ws_sold_date_sk = d_date_sk
	and d_date between cast(date('2001-04-30') as date) 
				and (cast(date('2001-04-30') as date) + interval '30' day)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
and cc_county in ('Walker County','Jefferson Davis Parish','Mobile County','Wadena County',
                  'Daviess County'
)
and exists (select *
...
select  i_item_id
 ...
 where cs_item_sk = i_item_sk 
   ...
   and cs_sold_date_sk = d_date_sk
 and d_date between cast(date('1998-03-30') as date) 
 				and (cast(date('1998-03-30') as date) + interval '30' day)
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
where 
	ss_item_sk = i_item_sk 
  	...
  	and ss_sold_date_sk = d_date_sk
	and d_date between cast(date('1999-03-29') as date) 
				and (cast(date('1999-03-29') as date) + interval '30' day)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Williamson County','Daviess County','Walker County','Richland County',
                           'Franklin Parish','Pennington County','Huron County','Luce County')
...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast(date('2000-08-28') as date) 
                  and (cast(date('2000-08-28') as date) + interval '14' day)
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('forest','lawn','light','moccasin','cornsilk','khaki') and
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('CA', 'NE', 'MN')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('MO', 'NC', 'WA')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('GA', 'TN', 'OH')
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (2000,2000+1,2000+2)
    and store.s_county in ('Levy County','Gogebic County','Ziebach County','Luce County')
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 20206279
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 37197065
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 10701805
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 19741492
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 26683795
            then (select avg(ss_ext_list_price)
                  from store_sales
