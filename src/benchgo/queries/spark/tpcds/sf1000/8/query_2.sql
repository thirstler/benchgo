...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('floral','almond','lemon'))
...
where 
	ss_item_sk = i_item_sk 
  	...
  	and ss_sold_date_sk = d_date_sk
	and d_date between cast(date('2002-06-21') as date) 
				and (cast(date('2002-06-21') as date) + interval '30' day)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast(date('2000-08-04') as date) 
                  and (cast(date('2000-08-04') as date) + interval '14' day)
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in (date('2002-02-08'),date('2002-10-01'),date('2002-11-04'))))
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 117 and 117+10 
             or ss_coupon_amt between 941 and 941+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 13 and 13+10
          or ss_coupon_amt between 1013 and 1013+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 76 and 76+10
          or ss_coupon_amt between 4265 and 4265+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 32 and 32+10
          or ss_coupon_amt between 8898 and 8898+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 49 and 49+10
          or ss_coupon_amt between 83 and 83+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 41 and 41+10
          or ss_coupon_amt between 8292 and 8292+1000
...
select  c_last_name
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and store.s_city in ('Woodlawn','Lakeview')
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '18371','26133','90086','12204','33656','86477',
                          '12392','40552','63014','88931','82192',
                          '51743','54523','71018','52828','58696',
                          '72680','60009','57354','57014','61234',
                          '53234','75649','40869','98871','79172',
                          '43222','54154','47324','32581','24498',
                          '18341','20988','66188','22942','20022',
                          '84857','58892','48645','67382','41920',
                          '93934','74508','96467','20437','46742',
                          '96392','77736','90941','52106','76544',
                          '64648','50162','61554','37929','97993',
                          '89551','95206','90374','46602','69492',
                          '75794','49058','86027','12649','63211',
                          '30450','79754','24137','77210','35624',
                          '50700','84039','62172','68001','98056',
                          '36681','35956','83249','46140','52201',
                          '27941','30353','82023','61389','45001',
                          '78785','49397','99666','34009','45861',
                          '78974','69868','16532','51574','82479',
                          '16196','33141','36930','73705','42844',
                          '88274','42553','85027','30187','90879',
                          '45568','81828','64814','83799','53118',
                          '46554','83200','50106','80663','27386',
                          '92997','55405','93865','60791','72236',
                          '82596','52989','89254','11235','65926',
                          '67345','97112','46271','84461','25399',
                          '47979','69958','40479','37370','51235',
                          '20937','12524','73775','41299','65706',
                          '24095','78428','68153','55209','29142',
                          '70853','97688','40982','40886','63920',
                          '78331','22368','26905','95104','86902',
                          '84118','39792','85372','73395','26806',
                          '54714','12048','97886','46045','59771',
                          '42004','29868','59340','46917','20235',
                          '58506','25974','21642','11302','66506',
                          '47750','11468','97934','95119','74580',
                          '73577','24363','60684','93800','27582',
                          '62122','56841','15009','69983','69931',
                          '46382','24753','68215','47063','46965',
                          '44058','98489','95453','62550','90956',
                          '72571','63538','11242','65192','37516',
                          '53334','28209','26842','74524','73284',
                          '21728','82482','31409','42702','80680',
                          '59129','36405','71565','89851','29105',
                          '75311','95316','54458','25235','77354',
                          '98606','27262','74774','82779','17471',
                          '28247','67951','92986','15585','46819',
                          '11089','91658','30561','82945','29849',
                          '12452','32687','87111','43798','18021',
                          '47346','54957','43707','20383','86148',
                          '34782','68973','41281','65929','52317',
                          '60358','83194','33686','22632','88857',
                          '67851','76340','48013','66306','45304',
                          '60481','86521','92150','33566','23907',
                          '24724','49913','92689','23309','76041',
                          '22726','41420','73123','50949','30650',
                          '99703','74226','73942','38155','39148',
                          '28878','94818','28370','49905','65944',
                          '52715','74144','53090','83607','92102',
                          '70943','97554','18627','34084','66981',
                          '40521','60348','57203','48444','10613',
                          '49685','13695','73704','92803','75993',
                          '21522','54007','43190','24820','61827',
                          '92324','27107','29391','32598','58048',
                          '21471','30073','96775','51630','67232',
                          '49235','49950','99836','87532','47137',
                          '68919','69565','36249','31854','16081',
                          '35639','43532','52353','14683','37569',
                          '85775','61821','37026','52706','66597',
                          '35463','70195','14565','96483','71606',
                          '66082','15396','37756','74459','54361',
                          '79489','42009','30379','46044','65465',
                          '34887','82733','57849','77582','18026',
                          '50528','61763','28875','67139','70851',
                          '46665','10512','22085','25611','22779',
                          '61440','80455','99823','57811','48267',
                          '28586','64352','32501','26694','26343',
                          '17836','96583','37113','95739','50469',
                          '58683','47991','58675','55342','13265',
                          '91678','69115','11609','89622')
     intersect
      select ca_zip
...
with ssr as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast(date('2001-08-14') as date) 
                  and (cast(date('2001-08-14') as date) + interval '30' day)
       and ss_store_sk = s_store_sk
       and ss_item_sk = i_item_sk
...
with ss as
 ...
 from store_sales,
      ...
      store
 where ss_sold_date_sk = d_date_sk
       and d_date between cast(date('2002-08-10') as date) 
                  and (cast(date('2002-08-10') as date) + interval '30' day) 
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
...
select  *
 from(select w_warehouse_name
            ,i_item_id
            ,sum(case when (cast(d_date as date) < cast (date('2002-03-08') as date))
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between (cast (date('2002-03-08') as date) - interval '30' day)
                    and (cast (date('2002-03-08') as date) + interval '30' day)
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Bayfield County','Gilmer County','Chilton County','Marshall County','Poquoson city') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
select  i_item_id
 ...
 and d_date between cast(date('1999-06-21') as date) and (cast(date('1999-06-21') as date) + interval '60' day)
 and i_manufact_id in (333,532,601,79)
...
and cc_county in ('Levy County','Bronx County','Luce County','Jefferson Davis Parish',
                  'Huron County'
)
and exists (select *
...
select  
   w_state
  ,i_item_id
  ,sum(case when (cast(d_date as date) < cast (date('2002-06-04') as date)) 
 ...
 and cs_warehouse_sk    = w_warehouse_sk 
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast (date('2002-06-04') as date) - interval '30' day)
                and (cast (date('2002-06-04') as date) + interval '30' day) 
 group by
    w_state,i_item_id
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Dauphin County','Jefferson Davis Parish','Williamson County','Daviess County')
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Bunker Hill'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  14059
   and ib_upper_bound   <=  14059 + 50000
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast(date('2000-02-22') as date) and (cast(date('2000-02-22') as date) + interval '60' day)
 and i_manufact_id in (878,901,828,911)
 and inv_quantity_on_hand between 100 and 500
 and cs_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
where 
	ws_item_sk = i_item_sk 
  	...
  	and ws_sold_date_sk = d_date_sk
	and d_date between cast(date('2001-05-30') as date) 
				and (cast(date('2001-05-30') as date) + interval '30' day)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('goldenrod','grey','metallic','rose','dark','lace') and
...
select  i_item_id
 ...
 from	catalog_sales
     ...
     ,date_dim
 where cs_item_sk = i_item_sk 
   and i_category in ('Home', 'Books', 'Jewelry')
   and cs_sold_date_sk = d_date_sk
 and d_date between cast(date('2002-02-20') as date) 
 				and (cast(date('2002-02-20') as date) + interval '30' day)
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 20512381
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 28964478
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 9221264
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 15985971
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 3607184
            then (select avg(ss_ext_list_price)
                  from store_sales
...
i_manufact_id = 321
and i_item_sk = cs_item_sk 
and d_date between date(date('2001-03-21')) and 
        (cast(date('2001-03-21') as date) + interval '90' day)
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (9,1,10,5,4,8) and
       d_year = 1998 and
       ca_state in ('NE','VA','TX'
                   ,'NC','MN','KS','CA')
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (2000,2000+1,2000+2)
    and store.s_county in ('Oglethorpe County','Bronx County','Franklin Parish','Ziebach County',
                           'Wadena County','Gogebic County','Luce County','Daviess County')
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('WY', 'KY', 'WV')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('FL', 'GA', 'MN')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('MI', 'NC', 'TX')
...
i_manufact_id = 574
and i_item_sk = ws_item_sk 
and d_date between date(date('2000-02-16')) and 
        (cast(date('2000-02-16') as date) + interval '90' day)
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1998,1998+1,1998+2) 
    and store.s_city in ('Woodlawn','Midway','Shiloh','Spring Hill','Highland') 
...
where ss_item_sk = i_item_sk and
      ...
      ss_store_sk = s_store_sk and
      d_year in (2001) and
        ((i_category in ('Sports','Music','Children') and
          i_class in ('fitness','classical','toddlers')
         )
      or (i_category in ('Electronics','Men','Home') and
          i_class in ('automotive','shirts','paint') 
        ))
...
select   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 1998
 	and t_time between 30346 and 30346+28800 
