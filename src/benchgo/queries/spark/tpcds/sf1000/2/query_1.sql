...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in (date('2002-02-01'),date('2002-10-21'),date('2002-11-04'))))
...
and d_date between date(date('1999-02-15')) and 
        (cast(date('1999-02-15') as date) + interval '90' day)
...
and d_date between date(date('2002-03-04')) and 
        (cast(date('2002-03-04') as date) + interval '90' day)
...
select   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 1999
 	and t_time between 31403 and 31403+28800 
 	and sm_carrier in ('MSC','LATVIAN')
     group by 
        w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Oakwood'
   ...
   and ib_lower_bound   >=  6550
   and ib_upper_bound   <=  6550 + 50000
...
where 
	...
	and d_date between cast(date('2002-06-13') as date) 
				and (cast(date('2002-06-13') as date) + interval '30' day)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
with ss as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast(date('2001-08-07') as date) 
                  and (cast(date('2001-08-07') as date) + interval '30' day) 
...
select  
   w_state
  ,i_item_id
  ,sum(case when (cast(d_date as date) < cast (date('2002-05-16') as date)) 
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast (date('2002-05-16') as date) - interval '30' day)
                and (cast (date('2002-05-16') as date) + interval '30' day) 
 group by
    w_state,i_item_id
...
where 
	ws_item_sk = i_item_sk 
  	...
  	and ws_sold_date_sk = d_date_sk
	and d_date between cast(date('2000-05-14') as date) 
				and (cast(date('2000-05-14') as date) + interval '30' day)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 83 and 83+10
          or ss_coupon_amt between 7228 and 7228+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 11 and 11+10
          or ss_coupon_amt between 8405 and 8405+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 119 and 119+10
          or ss_coupon_amt between 17616 and 17616+1000
 ...
 where i_manufact_id between 815 and 815+40 
   and (select count(*) as item_cnt
       ...
       (i_manufact = i1.i_manufact and
        ...
        (i_category = 'Men' and
        (i_color = 'peru' or i_color = 'orchid') and
...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast(date('2002-08-05') as date) 
                  and (cast(date('2002-08-05') as date) + interval '14' day)
...
select  i_item_id
 ...
 and d_date between cast(date('2001-02-13') as date) and (cast(date('2001-02-13') as date) + interval '60' day)
 and i_manufact_id in (772,427,323,144)
...
select  c_last_name
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and store.s_city in ('Pleasant Valley','Cedar Grove')
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast(date('2001-04-14') as date) and (cast(date('2001-04-14') as date) + interval '60' day)
 and i_manufact_id in (705,937,799,970)
 and inv_quantity_on_hand between 100 and 500
 and cs_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('green','ghost','lace','lime','goldenrod','lavender') and
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Woodlawn','Riverside','Midway','Highland','Mount Vernon') 
...
select  *
 from(select w_warehouse_name
            ,i_item_id
            ,sum(case when (cast(d_date as date) < cast (date('1998-05-08') as date))
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between (cast (date('1998-05-08') as date) - interval '30' day)
                    and (cast (date('1998-05-08') as date) + interval '30' day)
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1998,1998+1,1998+2)
    and store.s_county in ('Franklin Parish','Wadena County','Mesa County','Oglethorpe County',
                           'Raleigh County','Ziebach County','Pennington County','Luce County')
...
where ss_item_sk = i_item_sk and
      ...
      ss_store_sk = s_store_sk and
      d_year in (1998) and
        ((i_category in ('Home','Books','Jewelry') and
          i_class in ('accent','reference','earings')
         )
      or (i_category in ('Shoes','Music','Sports') and
          i_class in ('mens','classical','basketball') 
        ))
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1999,1999+1,1999+2)
    and store.s_county in ('Oglethorpe County','Richland County','Wadena County','Dauphin County')
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('gainsboro','lime','azure'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2000
 and     d_moy                   = 1
