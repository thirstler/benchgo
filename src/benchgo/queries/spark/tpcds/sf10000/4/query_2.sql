...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('maroon','pale','green'))
...
where 
	ss_item_sk = i_item_sk 
  	...
  	and ss_sold_date_sk = d_date_sk
	and d_date between cast(date('1998-05-21') as date) 
				and (cast(date('1998-05-21') as date) + interval '30' day)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast(date('2002-08-26') as date) 
                  and (cast(date('2002-08-26') as date) + interval '14' day)
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in (date('2000-05-22'),date('2000-08-02'),date('2000-11-12'))))
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 119 and 119+10 
             or ss_coupon_amt between 1884 and 1884+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 109 and 109+10
          or ss_coupon_amt between 9437 and 9437+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 46 and 46+10
          or ss_coupon_amt between 3667 and 3667+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 184 and 184+10
          or ss_coupon_amt between 17902 and 17902+1000
...
select  c_last_name
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and store.s_city in ('Riverdale','Bridgeport')
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '17713','57106','77972','13394','79353','43110',
                          '65637','10214','16233','27301','38815',
                          '80848','96587','28753','86511','43525',
                          '13418','84176','36964','48497','58959',
                          '62468','12684','98702','37446','69839',
                          '21321','26210','97436','25134','46559',
                          '20306','31076','79595','75841','65129',
                          '44175','94802','77961','72397','35763',
                          '46406','39473','67095','89057','78573',
                          '82861','22822','60162','51836','77147',
                          '14632','19544','85704','86433','12617',
                          '83191','19187','46541','48600','57205',
                          '50310','41883','75581','81206','57043',
                          '58629','43692','31191','52112','90050',
                          '12745','42464','41985','50084','88467',
                          '82711','49948','42412','23968','34834',
                          '20420','46065','81324','37212','14312',
                          '41712','10636','99497','54601','82656',
                          '66483','59271','88690','12223','44339',
                          '75238','24048','14691','89120','60241',
                          '22657','42212','28972','95206','34284',
                          '96076','75400','39773','39020','53560',
                          '34100','79578','19990','58853','38020',
                          '23175','96682','97272','61290','32686',
                          '91418','37272','43953','94512','80678',
                          '42487','75997','67440','94770','88224',
                          '37780','89124','18498','94488','52746',
                          '50436','83122','34635','65770','79848',
                          '46126','59813','97327','73392','54837',
                          '93211','86298','43504','70993','70263',
                          '55900','44943','95189','84076','97852',
                          '81906','54316','53951','36527','72071',
                          '30317','47854','54790','95567','59676',
                          '20032','28351','24533','97490','73947',
                          '37814','53196','27422','19891','24222',
                          '28672','17075','42305','87930','47392',
                          '16315','97664','69420','92425','28435',
                          '52050','13534','42831','79160','32552',
                          '99798','43798','59388','40231','78050',
                          '19874','22383','31872','61243','38230',
                          '89605','96752','57977','40950','37997',
                          '59443','88607','16226','54143','99065',
                          '31568','61359','55482','21447','99418',
                          '29964','81076','59655','16355','84857',
                          '46583','94738','85260','91345','47306',
                          '59283','98262','73264','95104','40710',
                          '60483','33972','22864','45386','23225',
                          '98167','17303','85532','38181','64492',
                          '81195','87059','26778','52503','86535',
                          '46804','64520','79289','15454','79363',
                          '65694','27323','87813','81517','86921',
                          '19261','80914','14995','46079','13398',
                          '20657','48394','41943','44293','48377',
                          '92128','73653','49026','15238','47365',
                          '37944','73946','19541','10444','94922',
                          '60374','30132','60897','60928','41302',
                          '60294','65462','87794','90882','10449',
                          '54085','79198','99724','78472','49616',
                          '24352','85045','56420','36163','22052',
                          '11316','34361','23321','51022','90207',
                          '51639','35213','50434','11196','89835',
                          '74472','70410','84931','21446','31861',
                          '24235','53197','18849','70437','14920',
                          '81603','38464','25233','63541','54160',
                          '83925','82997','51039','90975','51599',
                          '11502','10877','87912','68288','49311',
                          '37335','46189','71602','61245','39593',
                          '97362','68363','82318','29341','30986',
                          '68789','15754','29072','22998','48290',
                          '14030','29228','15256','30669','73465',
                          '39736','74955','88550','14214','10844',
                          '84702','33594','24774','62275','50772',
                          '94571','78237','85021','62679','90945',
                          '34915','81917','89918','30773','39146',
                          '70073','62799','95903','61120','41182',
                          '19805','25277','40898','80894','43482',
                          '24679','81336','11157','29467','54640',
                          '76531','57685','38455','47044','50919',
                          '82905','64276','74665','33311','17984',
                          '57934','21778','16727','41095')
     intersect
      select ca_zip
...
with ssr as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast(date('1999-08-02') as date) 
                  and (cast(date('1999-08-02') as date) + interval '30' day)
       and ss_store_sk = s_store_sk
       and ss_item_sk = i_item_sk
...
with ss as
 ...
 from store_sales,
      ...
      store
 where ss_sold_date_sk = d_date_sk
       and d_date between cast(date('1999-08-28') as date) 
                  and (cast(date('1999-08-28') as date) + interval '30' day) 
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
...
select  *
 from(select w_warehouse_name
            ,i_item_id
            ,sum(case when (cast(d_date as date) < cast (date('2001-06-15') as date))
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between (cast (date('2001-06-15') as date) - interval '30' day)
                    and (cast (date('2001-06-15') as date) + interval '30' day)
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Simpson County','Fall River County','Hopkins County','Hernando County','Nelson County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
select  i_item_id
 ...
 and d_date between cast(date('1998-06-29') as date) and (cast(date('1998-06-29') as date) + interval '60' day)
 and i_manufact_id in (545,170,830,535)
...
and cc_county in ('Mesa County','Pennington County','Richland County','Wadena County',
                  'Kittitas County'
)
and exists (select *
...
select  
   w_state
  ,i_item_id
  ,sum(case when (cast(d_date as date) < cast (date('2000-04-13') as date)) 
 ...
 and cs_warehouse_sk    = w_warehouse_sk 
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast (date('2000-04-13') as date) - interval '30' day)
                and (cast (date('2000-04-13') as date) + interval '30' day) 
 group by
    w_state,i_item_id
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Karnes County','Nuckolls County','Surry County','Levy County')
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Unionville'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  25096
   and ib_upper_bound   <=  25096 + 50000
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast(date('2001-03-20') as date) and (cast(date('2001-03-20') as date) + interval '60' day)
 and i_manufact_id in (951,835,924,752)
 and inv_quantity_on_hand between 100 and 500
 and cs_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
from
  ...
  ,web_site
where
    d_date between date(date('2001-5-01')) and 
           (cast(date('2001-5-01') as date) + interval '60' day)
and ws1.ws_ship_date_sk = d_date_sk
and ws1.ws_ship_addr_sk = ca_address_sk
and ca_state = 'ID'
and ws1.ws_web_site_sk = web_site_sk
...
where 
	ws_item_sk = i_item_sk 
  	...
  	and ws_sold_date_sk = d_date_sk
	and d_date between cast(date('2001-02-01') as date) 
				and (cast(date('2001-02-01') as date) + interval '30' day)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('plum','almond','cream','thistle','brown','violet') and
...
select  i_item_id
 ...
 where cs_item_sk = i_item_sk 
   ...
   and cs_sold_date_sk = d_date_sk
 and d_date between cast(date('2001-04-02') as date) 
 				and (cast(date('2001-04-02') as date) + interval '30' day)
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 82271817
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 279625988
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 335171987
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 447699034
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 245685663
            then (select avg(ss_ext_sales_price)
                  from store_sales
...
i_manufact_id = 418
and i_item_sk = cs_item_sk 
and d_date between date(date('2002-03-08')) and 
        (cast(date('2002-03-08') as date) + interval '90' day)
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (7,2,10,4,1,11) and
       d_year = 2002 and
       ca_state in ('GA','NE','UT'
                   ,'OH','WV','TX','ME')
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1999,1999+1,1999+2)
    and store.s_county in ('West Feliciana Parish','Montgomery County','Fairfield County','Camden County',
                           'Terry County','Stillwater County','Huron County','Richland County')
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('WV', 'WI', 'LA')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('OH', 'VA', 'KS')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('KY', 'IA', 'UT')
...
select  distinct(i_product_name)
 ...
 where i_manufact_id between 820 and 820+40 
   and (select count(*) as item_cnt
        ...
        (i_color = 'midnight' or i_color = 'azure') and 
       ...
       (i_manufact = i1.i_manufact and
        ...
        (i_category = 'Men' and
        (i_color = 'blue' or i_color = 'dim') and
...
i_manufact_id = 947
and i_item_sk = ws_item_sk 
and d_date between date(date('1998-02-08')) and 
        (cast(date('1998-02-08') as date) + interval '90' day)
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Manchester','Lakeside','Clifton','Lakeview','Petersburg') 
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2001) and
        ((i_category in ('Music','Children','Shoes') and
          i_class in ('rock','school-uniforms','athletic')
         )
      or (i_category in ('Jewelry','Women','Home') and
          i_class in ('pendants','dresses','lighting') 
        ))
...
select   
 ...
 from (
 	...
 	,w_state
 	,w_country
 	,'ZHOU' || ',' || 'ALLIANCE' as ship_carriers
       ,d_year as year
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 1998
 	and t_time between 52302 and 52302+28800 
 	and sm_carrier in ('ZHOU','ALLIANCE')
     group by 
        w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
