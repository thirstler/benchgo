...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in (date('2001-04-25'),date('2001-09-22'),date('2001-11-16'))))
...
and d_date between date(date('1998-03-13')) and 
        (cast(date('1998-03-13') as date) + interval '90' day)
...
and d_date between date(date('1998-01-27')) and 
        (cast(date('1998-01-27') as date) + interval '90' day)
...
select   
 ...
 from (
 	...
 	,w_state
 	,w_country
 	,'PRIVATECARRIER' || ',' || 'HARMSTORF' as ship_carriers
       ,d_year as year
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2000
 	and t_time between 12923 and 12923+28800 
 	and sm_carrier in ('PRIVATECARRIER','HARMSTORF')
     group by 
        w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Salem'
   ...
   and ib_lower_bound   >=  5841
   and ib_upper_bound   <=  5841 + 50000
...
where 
	...
	and d_date between cast(date('1999-05-21') as date) 
				and (cast(date('1999-05-21') as date) + interval '30' day)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
from
  ...
  ,call_center
where
    d_date between date(date('2002-5-01')) and 
           (cast(date('2002-5-01') as date) + interval '60' day)
and cs1.cs_ship_date_sk = d_date_sk
and cs1.cs_ship_addr_sk = ca_address_sk
and ca_state = 'CA'
and cs1.cs_call_center_sk = cc_call_center_sk
and cc_county in ('Barrow County','Jackson County','Walker County','Gogebic County',
                  'Luce County'
)
and exists (select *
...
with ss as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast(date('1998-08-05') as date) 
                  and (cast(date('1998-08-05') as date) + interval '30' day) 
...
select  
   w_state
  ,i_item_id
  ,sum(case when (cast(d_date as date) < cast (date('1999-06-23') as date)) 
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast (date('1999-06-23') as date) - interval '30' day)
                and (cast (date('1999-06-23') as date) + interval '30' day) 
 group by
    w_state,i_item_id
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('VA', 'AL', 'TX')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('SD', 'TN', 'VT')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('OH', 'ME', 'IN')
...
where 
	ws_item_sk = i_item_sk 
  	...
  	and ws_sold_date_sk = d_date_sk
	and d_date between cast(date('1998-02-08') as date) 
				and (cast(date('1998-02-08') as date) + interval '30' day)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 26 and 26+10 
             or ss_coupon_amt between 248 and 248+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 19 and 19+10
          or ss_coupon_amt between 1565 and 1565+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 145 and 145+10
          or ss_coupon_amt between 17695 and 17695+1000
...
select  distinct(i_product_name)
 ...
 where i_manufact_id between 978 and 978+40 
   and (select count(*) as item_cnt
        ...
        (i_category = 'Women' and
        (i_color = 'turquoise' or i_color = 'violet') and
       ...
       (i_manufact = i1.i_manufact and
        ...
        (i_category = 'Men' and
        (i_color = 'cornsilk' or i_color = 'purple') and
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '95267','64272','64239','81478','28119','85479',
                          '72268','75528','44181','66836','95984',
                          '90401','44680','80315','35369','51532',
                          '83230','15448','89638','33127','98331',
                          '57760','66565','41042','82375','17481',
                          '85659','65601','24670','91990','98845',
                          '92988','53558','35474','68673','24366',
                          '87554','42933','69459','63221','98974',
                          '43805','35804','95961','14825','55711',
                          '69270','74711','64900','61925','44913',
                          '88995','12620','19713','77031','76606',
                          '23438','13518','49841','83582','32046',
                          '42392','73587','50596','10412','72685',
                          '73009','58098','10634','12606','44551',
                          '55602','22848','13327','70445','20433',
                          '52775','55541','52254','67354','30679',
                          '92706','20682','14570','34053','87683',
                          '20649','83841','40666','25360','25398',
                          '30990','85850','98433','61416','63848',
                          '15464','81596','94126','33209','53229',
                          '25513','78193','83095','26334','33554',
                          '89837','96011','81295','92634','78031',
                          '83221','31494','15829','64548','41608',
                          '69410','46922','84308','21392','68260',
                          '67511','70936','59561','61986','87136',
                          '74216','89798','43272','10128','95526',
                          '48975','91281','27295','46015','10597',
                          '55043','46597','59627','10274','43007',
                          '31279','33014','98937','87275','19093',
                          '88838','10691','37261','82793','25880',
                          '75706','27861','62866','53819','37566',
                          '22400','47802','72995','47213','71913',
                          '23865','21489','38220','77379','31843',
                          '10639','12236','86534','39835','52306',
                          '75381','15859','65801','20848','24486',
                          '99857','13300','97037','20995','43246',
                          '53352','40156','40806','48646','57597',
                          '70547','69588','32751','39446','15108',
                          '63503','40609','38142','74696','12051',
                          '66858','59481','63121','43670','15439',
                          '88470','70752','48731','11710','23876',
                          '64936','19925','38278','26465','35508',
                          '35309','31787','24450','27564','17756',
                          '79648','13549','51225','34232','79715',
                          '29353','32165','13074','78180','69666',
                          '71702','35703','21876','43421','59287',
                          '89983','68253','60336','54951','60817',
                          '59877','33025','47520','42542','56032',
                          '78273','98644','27755','19135','17272',
                          '32315','69446','63241','58496','24089',
                          '33392','26005','32776','33207','38368',
                          '33388','35801','51950','21959','72743',
                          '74225','98875','98009','39870','88891',
                          '51593','27816','70092','38879','98614',
                          '40259','45619','44371','26669','93802',
                          '18491','26902','35970','12581','80515',
                          '34178','46845','41292','60044','70116',
                          '83498','94904','88134','40199','52371',
                          '72431','48935','25121','46374','98104',
                          '31811','30943','24311','68281','82199',
                          '65207','13859','60174','91861','43727',
                          '18313','57416','22013','34513','75766',
                          '90168','71619','80499','69530','75086',
                          '60606','27800','57223','80093','37490',
                          '96242','88194','90840','24083','96556',
                          '52724','63348','26644','97794','70797',
                          '93153','47860','21052','41980','77114',
                          '13024','94413','26813','18035','28398',
                          '91463','99958','28602','78387','93894',
                          '43429','19195','83412','89135','25704',
                          '31464','59743','76529','85006','70292',
                          '18248','60515','22453','51972','55572',
                          '27745','74087','47310','49488','92745',
                          '60417','64135','93784','32619','28073',
                          '33512','77864','46398','29462','49921',
                          '52198','21200','34631','95878','55756',
                          '13769','98815','74931','38546','30800',
                          '29565','65402','17086','94910','44137',
                          '36464','92697','56838','31373','18757',
                          '44060','97924','27200','34444')
     intersect
      select ca_zip
...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast(date('2002-08-22') as date) 
                  and (cast(date('2002-08-22') as date) + interval '14' day)
...
select  i_item_id
 ...
 and d_date between cast(date('2002-03-15') as date) and (cast(date('2002-03-15') as date) + interval '60' day)
 and i_manufact_id in (728,450,80,149)
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (5,9,2,1,4,10) and
       d_year = 2001 and
       ca_state in ('IL','GA','LA'
                   ,'MT','KY','TX','ND')
...
select  c_last_name
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and store.s_city in ('Waterloo','Washington')
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 292820717
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 367088156
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 406761622
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 218150091
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 240402466
            then (select avg(ss_ext_list_price)
                  from store_sales
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast(date('2001-05-26') as date) and (cast(date('2001-05-26') as date) + interval '60' day)
 and i_manufact_id in (751,801,996,847)
 and inv_quantity_on_hand between 100 and 500
 and cs_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
with ssr as
 (select  s_store_id as store_id,
  ...
  from store_sales left outer join store_returns on
     ...
     promotion
 where ss_sold_date_sk = d_date_sk
       and d_date between cast(date('2001-08-06') as date) 
                  and (cast(date('2001-08-06') as date) + interval '30' day)
       and ss_store_sk = s_store_sk
       and ss_item_sk = i_item_sk
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('blanched','metallic','beige','cream','brown','misty') and
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1999,1999+1,1999+2) 
    and store.s_city in ('Fairfield','Anderson','Springdale','Hollywood','Pleasant Hill') 
...
select  *
 from(select w_warehouse_name
            ,i_item_id
            ,sum(case when (cast(d_date as date) < cast (date('2002-05-06') as date))
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between (cast (date('2002-05-06') as date) - interval '30' day)
                    and (cast (date('2002-05-06') as date) + interval '30' day)
...
select  i_item_id
 ...
 where cs_item_sk = i_item_sk 
   ...
   and cs_sold_date_sk = d_date_sk
 and d_date between cast(date('2002-05-09') as date) 
 				and (cast(date('2002-05-09') as date) + interval '30' day)
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Sumner County','Cocke County','Kittitas County','Marshall County',
                           'Anderson County','Bronx County','Barrow County','Adams County')
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2001) and
        ((i_category in ('Books','Sports','Children') and
          i_class in ('science','outdoor','school-uniforms')
         )
      or (i_category in ('Music','Shoes','Home') and
          i_class in ('classical','kids','furniture') 
        ))
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Blount County','Falls County','Taylor County','Piatt County','Levy County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (2000,2000+1,2000+2)
    and store.s_county in ('Stillwater County','Surry County','Barrow County','Walker County')
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('navy','hot','beige'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2000
 and     d_moy                   = 3
