...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Arthur County','Gogebic County','Somerset County','Williamson County')
...
select   
 ...
 from (
 	...
 	,w_state
 	,w_country
 	,'ORIENTAL' || ',' || 'HARMSTORF' as ship_carriers
       ,d_year as year
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2000
 	and t_time between 31683 and 31683+28800 
 	and sm_carrier in ('ORIENTAL','HARMSTORF')
     group by 
        w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
...
where 
	ss_item_sk = i_item_sk 
  	...
  	and ss_sold_date_sk = d_date_sk
	and d_date between cast(date('2001-06-12') as date) 
				and (cast(date('2001-06-12') as date) + interval '30' day)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('AR', 'GA', 'AL')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('ND', 'IN', 'WI')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('WA', 'NE', 'MN')
...
select  *
 from(select w_warehouse_name
            ,i_item_id
            ,sum(case when (cast(d_date as date) < cast (date('2000-06-19') as date))
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between (cast (date('2000-06-19') as date) - interval '30' day)
                    and (cast (date('2000-06-19') as date) + interval '30' day)
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('papaya','saddle','rose'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2002
 and     d_moy                   = 4
...
with ss as
 ...
 from store_sales,
      ...
      store
 where ss_sold_date_sk = d_date_sk
       and d_date between cast(date('1998-08-17') as date) 
                  and (cast(date('1998-08-17') as date) + interval '30' day) 
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
...
and d_date between date(date('2001-02-10')) and 
        (cast(date('2001-02-10') as date) + interval '90' day)
...
select  c_last_name
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and date_dim.d_year in (1998,1998+1,1998+2)
        and store.s_city in ('Mill Creek','Buffalo')
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 78 and 78+10
          or ss_coupon_amt between 10479 and 10479+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 95 and 95+10
          or ss_coupon_amt between 4702 and 4702+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 108 and 108+10
          or ss_coupon_amt between 13998 and 13998+1000
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (10,3,6,1,4,7) and
       d_year = 2000 and
       ca_state in ('WI','MO','IA'
                   ,'WV','TN','MN','IN')
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '48706','58080','68366','85423','70849','26002',
                          '59854','88134','61449','94061','32672',
                          '67218','17676','51618','80331','22208',
                          '16840','86704','43942','99957','89538',
                          '70791','25813','50214','74797','81282',
                          '88141','87076','56563','38775','98008',
                          '84377','70840','82704','57211','48198',
                          '80445','43697','31027','87906','22746',
                          '91787','79006','81297','30023','28102',
                          '80873','25712','26043','49554','69074',
                          '63176','34074','60370','35836','29581',
                          '25147','48576','51303','80784','95804',
                          '95140','74404','49159','77183','79088',
                          '12254','93571','27078','47518','15028',
                          '39625','10621','47303','48801','98290',
                          '29235','35749','29453','65495','72145',
                          '73518','40176','93083','40411','52242',
                          '96409','52967','60016','66836','38467',
                          '24574','46637','25618','53006','20467',
                          '26271','80598','52480','49391','80883',
                          '93246','30275','72823','55410','34607',
                          '21727','16133','74759','19008','46169',
                          '71467','30282','82025','39372','50573',
                          '40087','39609','85755','67942','88550',
                          '69574','12226','86546','51666','76887',
                          '10289','23200','10238','16933','13020',
                          '61970','43428','75420','49627','95938',
                          '50915','33445','79405','65063','82490',
                          '60357','84286','38445','48917','31156',
                          '21812','62319','61959','59082','16312',
                          '26596','37267','56503','55071','10505',
                          '32777','38860','84077','88312','59547',
                          '85131','60802','22355','44386','36777',
                          '84336','50990','59210','50546','70171',
                          '43870','44512','28204','47204','24941',
                          '53292','39964','86127','36852','50338',
                          '63080','32296','32934','95491','86029',
                          '23882','40588','41969','34632','36419',
                          '98802','49620','36412','98938','26230',
                          '24212','39649','67799','68313','39968',
                          '71954','22605','24121','37522','49771',
                          '84108','98934','13923','12906','59094',
                          '13559','39287','44434','83182','61328',
                          '68437','95451','40134','91567','95308',
                          '87510','72080','31525','95006','98410',
                          '80338','89867','86448','53567','33550',
                          '93764','50013','27608','62885','91360',
                          '75275','29982','59382','13425','42563',
                          '22422','17352','48592','42322','42367',
                          '87839','24525','16147','26987','94495',
                          '75450','27863','98237','66263','94473',
                          '35592','48765','59956','36181','88404',
                          '42572','30315','13351','51824','87684',
                          '34534','14279','24487','10500','27352',
                          '66639','35514','95793','39976','95469',
                          '41446','16343','49383','43506','50420',
                          '72886','35390','68093','89534','61079',
                          '22051','34676','10885','99181','36415',
                          '29508','95622','41687','29494','13791',
                          '70265','79282','25804','61795','88699',
                          '72281','16002','58050','42188','95228',
                          '33428','21140','31737','55058','11574',
                          '20639','88190','70675','21041','42665',
                          '26930','37890','89137','73301','29232',
                          '41760','77087','12017','71097','77020',
                          '37369','21583','58466','14339','54434',
                          '20407','37961','28552','33183','93755',
                          '99244','98817','12045','67477','30122',
                          '51011','43865','78331','57890','49040',
                          '61472','66548','77082','41749','34750',
                          '23729','15137','79998','81771','60170',
                          '57011','34968','71279','11648','90938',
                          '71632','73502','87458','65494','58713',
                          '38554','18291','73684','67256','77442',
                          '82082','62738','19663','21109','72487',
                          '18700','11783','63316','39789','81400',
                          '56487','79995','53461','97143','36820',
                          '64406','68918','58395','55605','70544',
                          '12856','66460','66416','79063','73912',
                          '76177','10605','43519','36812')
     intersect
      select ca_zip
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1998,1998+1,1998+2) 
    and store.s_city in ('Cross Roads','Bunker Hill','Forest Hills','Hopewell','Mount Vernon') 
...
and d_date between date(date('1998-02-03')) and 
        (cast(date('1998-02-03') as date) + interval '90' day)
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Glenwood'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  39430
   and ib_upper_bound   <=  39430 + 50000
...
where ss_item_sk = i_item_sk and
      ...
      ss_store_sk = s_store_sk and
      d_year in (2000) and
        ((i_category in ('Electronics','Books','Sports') and
          i_class in ('automotive','sports','fitness')
         )
      or (i_category in ('Jewelry','Music','Women') and
          i_class in ('jewelry boxes','pop','fragrances') 
        ))
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in (date('2002-01-26'),date('2002-09-23'),date('2002-11-14'))))
...
select  
   w_state
  ,i_item_id
  ,sum(case when (cast(d_date as date) < cast (date('2000-04-25') as date)) 
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast (date('2000-04-25') as date) - interval '30' day)
                and (cast (date('2000-04-25') as date) + interval '30' day) 
 group by
    w_state,i_item_id
...
and cc_county in ('Mesa County','Kittitas County','Ziebach County','Gogebic County',
                  'Fairfield County'
)
and exists (select *
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('rose','beige','navy','blanched','lime','coral') and
...
select  i_item_id
 ...
 from	catalog_sales
     ...
     ,date_dim
 where cs_item_sk = i_item_sk 
   and i_category in ('Music', 'Jewelry', 'Men')
   and cs_sold_date_sk = d_date_sk
 and d_date between cast(date('1999-03-18') as date) 
 				and (cast(date('1999-03-18') as date) + interval '30' day)
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast(date('2001-08-04') as date) 
                  and (cast(date('2001-08-04') as date) + interval '14' day)
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Clinch County','Meade County','Sarasota County','Rockland County','Benton County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
where 
	ws_item_sk = i_item_sk 
  	...
  	and ws_sold_date_sk = d_date_sk
	and d_date between cast(date('2002-06-29') as date) 
				and (cast(date('2002-06-29') as date) + interval '30' day)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select  i_item_id
 ...
 and d_date between cast(date('2002-05-18') as date) and (cast(date('2002-05-18') as date) + interval '60' day)
 and i_manufact_id in (954,767,856,754)
 ...
 where i_manufact_id between 861 and 861+40 
   and (select count(*) as item_cnt
       ...
       (i_manufact = i1.i_manufact and
        ...
        (i_category = 'Men' and
        (i_color = 'medium' or i_color = 'mint') and
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 437394781
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 172665640
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 256697274
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 470296923
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 241848217
            then (select avg(ss_ext_discount_amt)
                  from store_sales
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1999,1999+1,1999+2)
    and store.s_county in ('Red River Parish','Somerset County','Grant County','Anderson County',
                           'Cocke County','Tehama County','Williamson County','Carter County')
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast(date('2002-05-03') as date) and (cast(date('2002-05-03') as date) + interval '60' day)
 and i_manufact_id in (434,536,431,274)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
