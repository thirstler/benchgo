 ...
 where i_manufact_id between 985 and 985+40 
   and (select count(*) as item_cnt
       ...
       (i_manufact = i1.i_manufact and
        ((i_category = 'Women' and 
        (i_color = 'bisque' or i_color = 'burlywood') and 
        (i_units = 'Dozen' or i_units = 'Dram') and
        (i_size = 'medium' or i_size = 'petite')
        ) or
        (i_category = 'Women' and
        (i_color = 'beige' or i_color = 'lime') and
...
and d_date between date(date('2001-01-15')) and 
        (cast(date('2001-01-15') as date) + interval '90' day)
...
select   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 1998
 	and t_time between 54259 and 54259+28800 
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Shiloh'
   ...
   and ib_lower_bound   >=  59784
   and ib_upper_bound   <=  59784 + 50000
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '78701','69246','35383','99118','29251','19994',
                          '50908','97726','62633','11895','37695',
                          '28498','74092','13983','61907','64137',
                          '27652','28551','16028','77749','65865',
                          '30999','18706','64761','32711','91695',
                          '36547','36748','22447','67085','55124',
                          '46580','71155','72271','33843','51237',
                          '66893','95992','13435','16797','40360',
                          '18442','72550','26053','32055','60849',
                          '79970','86418','20836','78769','67815',
                          '20384','31950','97625','92285','81004',
                          '50376','79834','96161','16016','65628',
                          '27599','11730','99239','30118','57994',
                          '60244','74781','26218','83047','61478',
                          '16476','67770','72563','42307','88076',
                          '44117','55976','59776','65389','14241',
                          '92916','59860','86979','33400','76334',
                          '85001','21348','27592','95763','93576',
                          '83782','84530','38038','33176','62665',
                          '20524','51409','76975','27014','93037',
                          '66397','30664','54706','51665','64586',
                          '30994','51177','73148','94329','83381',
                          '83083','76998','14018','55353','83830',
                          '72120','48004','16392','95684','98224',
                          '44351','33991','11227','39244','35887',
                          '42081','60545','65670','65777','52813',
                          '30321','94578','68415','55575','73884',
                          '94034','81494','31283','31629','52986',
                          '91448','44041','13870','91619','87988',
                          '69783','47835','27905','67133','39897',
                          '34238','20904','17007','69089','36186',
                          '47708','87462','47000','10840','56290',
                          '11348','86560','26403','36650','73964',
                          '85473','57228','85550','63833','82304',
                          '56493','35797','79147','16566','23700',
                          '43078','54829','42176','79944','44177',
                          '77650','56622','54724','38586','32296',
                          '35171','69373','75395','66838','97605',
                          '91023','78054','68252','85231','83986',
                          '77338','55193','28876','22602','70245',
                          '32193','76932','37117','43962','82367',
                          '91769','30684','71899','33149','43593',
                          '47184','16499','58010','40416','63087',
                          '95558','41721','45496','10110','61602',
                          '75634','57277','25984','45800','47686',
                          '65459','68422','43684','56103','42101',
                          '13989','54677','73317','86786','79794',
                          '79236','42941','32610','73227','46857',
                          '10638','95332','47543','37110','99762',
                          '63490','30242','29347','84321','45721',
                          '96544','70843','92330','73131','57560',
                          '96920','31211','81185','74016','91566',
                          '96539','14998','48182','63025','60932',
                          '61192','19693','74246','67803','80794',
                          '61223','72070','12028','26413','87022',
                          '95619','58954','55670','55686','42469',
                          '66502','76449','62153','33284','53903',
                          '99203','29609','65418','49736','76592',
                          '82489','81480','24245','37326','99598',
                          '61544','39415','59066','11076','33228',
                          '57162','58188','71812','77061','14447',
                          '90197','11627','56791','16717','10818',
                          '24269','73583','32404','28237','90764',
                          '69263','23730','97506','66205','72716',
                          '18430','90912','60952','76364','82931',
                          '70498','18373','34473','17467','89047',
                          '85601','51273','81129','97070','44862',
                          '41242','59677','18646','54504','31206',
                          '76713','74064','50236','86862','50018',
                          '35153','83860','18378','61151','82195',
                          '90579','52353','92581','83016','67628',
                          '81526','52546','67871','78315','25149',
                          '35928','65957','64183','72192','92753',
                          '71503','98439','30798','55171','95471',
                          '34919','31558','27832','52286','80278',
                          '25872','76916','67985','36856','22642',
                          '72273','87199','26126','98018','88473',
                          '84453','68056','28516','63700','26782',
                          '27184','96570','30012','36878','23126',
                          '80268','98100','98777','72238')
     intersect
      select ca_zip
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2002) and
        ((i_category in ('Music','Sports','Men') and
          i_class in ('rock','pools','sports-apparel')
         )
      or (i_category in ('Children','Jewelry','Women') and
          i_class in ('infants','diamonds','dresses') 
        ))
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Red Hill','Mountain View','Union Hill','Norwood','Mount Pleasant') 
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in (date('1998-06-01'),date('1998-09-14'),date('1998-11-07'))))
...
select  *
 from(select w_warehouse_name
            ,i_item_id
            ,sum(case when (cast(d_date as date) < cast (date('1998-04-07') as date))
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between (cast (date('1998-04-07') as date) - interval '30' day)
                    and (cast (date('1998-04-07') as date) + interval '30' day)
...
select  
   w_state
  ,i_item_id
  ,sum(case when (cast(d_date as date) < cast (date('1998-04-14') as date)) 
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast (date('1998-04-14') as date) - interval '30' day)
                and (cast (date('1998-04-14') as date) + interval '30' day) 
 group by
    w_state,i_item_id
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 34 and 34+10
          or ss_coupon_amt between 2784 and 2784+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 136 and 136+10
          or ss_coupon_amt between 13974 and 13974+1000
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (5,6,3,7,1,11) and
       d_year = 1998 and
       ca_state in ('MI','MO','KS'
                   ,'NY','SC','KY','GA')
...
select  i_item_id
 ...
 and d_date between cast(date('1998-01-21') as date) and (cast(date('1998-01-21') as date) + interval '60' day)
 and i_manufact_id in (674,927,964,826)
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Lincoln County','Highland County','Rush County','Pasquotank County','Henderson County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
and d_date between date(date('1999-02-23')) and 
        (cast(date('1999-02-23') as date) + interval '90' day)
...
select  i_item_id
 ...
 and i_manufact_id in (941,35,485,575)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
with ssr as
 (select  s_store_id as store_id,
  ...
  from store_sales left outer join store_returns on
     ...
     promotion
 where ss_sold_date_sk = d_date_sk
       and d_date between cast(date('1998-08-07') as date) 
                  and (cast(date('1998-08-07') as date) + interval '30' day)
       and ss_store_sk = s_store_sk
       and ss_item_sk = i_item_sk
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('lemon','lime','mint'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2001
 and     d_moy                   = 4
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and (household_demographics.hd_dep_count = 7 or
             household_demographics.hd_vehicle_count= -1)
        and date_dim.d_year in (1999,1999+1,1999+2)
        and store.s_city in ('Shiloh','Oakdale')
...
where 
	ws_item_sk = i_item_sk 
  	and i_category in ('Women', 'Music', 'Children')
  	and ws_sold_date_sk = d_date_sk
	and d_date between cast(date('1998-05-28') as date) 
				and (cast(date('1998-05-28') as date) + interval '30' day)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
and cc_county in ('Daviess County','Pennington County','Williamson County','Kittitas County',
                  'Richland County'
)
and exists (select *
...
select  i_item_id
 ...
 where cs_item_sk = i_item_sk 
   ...
   and cs_sold_date_sk = d_date_sk
 and d_date between cast(date('2001-01-07') as date) 
 				and (cast(date('2001-01-07') as date) + interval '30' day)
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
where 
	ss_item_sk = i_item_sk 
  	...
  	and ss_sold_date_sk = d_date_sk
	and d_date between cast(date('1999-05-17') as date) 
				and (cast(date('1999-05-17') as date) + interval '30' day)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (2000,2000+1,2000+2)
    and store.s_county in ('Mobile County','Salem County','Richland County','Sumner County',
                           'Mesa County','Orange County','Abbeville County','Carter County')
...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast(date('1998-08-28') as date) 
                  and (cast(date('1998-08-28') as date) + interval '14' day)
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('yellow','azure','beige','sandy','ivory','drab') and
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('MS', 'ID', 'GA')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('TX', 'WI', 'NE')
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1999,1999+1,1999+2)
    and store.s_county in ('Marshall County','San Miguel County','Arthur County','Appanoose County')
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 106738138
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 215264812
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 205013467
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 270721784
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 194085987
            then (select avg(ss_ext_sales_price)
                  from store_sales
