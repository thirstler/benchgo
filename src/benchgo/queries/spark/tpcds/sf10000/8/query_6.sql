...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Mobile County','Anderson County','Camden County','Carter County',
                           'Wadena County','San Miguel County','Arthur County','Van Buren County')
...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast(date('2000-08-20') as date) 
                  and (cast(date('2000-08-20') as date) + interval '14' day)
...
select  i_item_id
 ...
 where cs_item_sk = i_item_sk 
   ...
   and cs_sold_date_sk = d_date_sk
 and d_date between cast(date('2002-05-10') as date) 
 				and (cast(date('2002-05-10') as date) + interval '30' day)
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1999,1999+1,1999+2)
    and store.s_county in ('Terrell County','Pennington County','Maverick County','Perry County')
...
with ssr as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast(date('1999-08-23') as date) 
                  and (cast(date('1999-08-23') as date) + interval '30' day)
       and ss_store_sk = s_store_sk
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 435635259
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 286364443
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 310130501
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 475053764
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 263560983
            then (select avg(ss_ext_discount_amt)
                  from store_sales
...
and d_date between date(date('2001-02-02')) and 
        (cast(date('2001-02-02') as date) + interval '90' day)
...
where ss_item_sk = i_item_sk and
      ...
      ss_store_sk = s_store_sk and
      d_year in (1998) and
        ((i_category in ('Women','Jewelry','Children') and
          i_class in ('maternity','womens watch','newborn')
         )
      or (i_category in ('Electronics','Men','Home') and
          i_class in ('cameras','shirts','furniture') 
        ))
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 170 and 170+10 
             or ss_coupon_amt between 3270 and 3270+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 55 and 55+10
          or ss_coupon_amt between 1569 and 1569+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 158 and 158+10
          or ss_coupon_amt between 16516 and 16516+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 45 and 45+10
          or ss_coupon_amt between 12230 and 12230+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 54 and 54+10
          or ss_coupon_amt between 14586 and 14586+1000
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (2,3,4,5,12,11) and
       d_year = 1998 and
       ca_state in ('NY','MN','MD'
                   ,'FL','GA','TX','AL')
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Cedar Grove'
   ...
   and ib_lower_bound   >=  5999
   and ib_upper_bound   <=  5999 + 50000
...
select  i_item_id
 ...
 and i_manufact_id in (484,20,548,501)
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '79243','48980','75721','97326','53630','68038',
                          '75523','74636','42005','68366','81835',
                          '27201','55820','26884','54294','54668',
                          '52646','13504','49502','91525','94506',
                          '60781','91074','39662','20394','91008',
                          '81692','43477','48606','29116','81351',
                          '42760','44697','75664','40373','25021',
                          '57586','54192','66254','63866','35534',
                          '19488','70082','33184','29072','41934',
                          '75476','63056','47354','54934','71568',
                          '11896','59998','58137','94747','29618',
                          '34355','37522','18543','44530','51337',
                          '50268','62793','68820','91301','57374',
                          '49737','37523','20487','24059','12204',
                          '84322','52713','59524','42119','96520',
                          '14747','64350','84563','63357','79372',
                          '90857','14075','50116','25527','96942',
                          '45300','21677','58135','52041','82399',
                          '47751','54162','60750','94007','93468',
                          '84138','12423','33994','37552','72471',
                          '38997','97188','72864','20509','12650',
                          '91950','64368','97293','42319','49692',
                          '34054','30468','41075','42789','39805',
                          '58176','53503','21589','20334','79333',
                          '77844','62892','72997','97399','42681',
                          '48240','66548','49721','18275','80220',
                          '23613','10277','98998','50809','73727',
                          '24118','13339','27762','31418','39623',
                          '93381','65143','83344','41464','35727',
                          '44405','91879','10310','41544','93023',
                          '94246','55844','75114','42050','56200',
                          '69734','19603','95722','79974','27630',
                          '27337','73778','51505','48528','19012',
                          '42371','63880','94462','73887','79960',
                          '31657','92578','26152','40957','74922',
                          '57169','75941','95602','60341','41946',
                          '48716','82227','16110','97904','65520',
                          '47531','13500','25366','27883','81792',
                          '17960','19218','56029','39438','87278',
                          '61278','67181','55377','24103','72142',
                          '86909','80916','72753','18320','27339',
                          '10108','72307','78343','77386','59453',
                          '14721','48498','80117','99282','20909',
                          '39676','17836','68489','92424','64839',
                          '95699','53036','48840','67693','72402',
                          '92770','60064','25950','83790','32514',
                          '53206','66921','52494','17692','94234',
                          '50018','73494','52924','79125','89465',
                          '83988','23466','61104','67848','13404',
                          '54600','49225','19388','78282','96225',
                          '30463','52407','38092','90827','19904',
                          '97112','70213','71953','96747','61772',
                          '56424','49126','38387','78405','97300',
                          '71772','88970','37850','74050','45310',
                          '92955','73966','15979','89220','26792',
                          '25805','79194','97522','98631','31194',
                          '81737','97290','71719','87513','12958',
                          '87643','50638','17662','55701','54597',
                          '72592','13883','34036','19270','50258',
                          '74646','18224','72678','25369','37951',
                          '95363','45392','85995','86197','18071',
                          '39759','95535','76188','54868','81782',
                          '49067','71451','30127','21980','63888',
                          '42470','83832','78061','52244','45395',
                          '96539','78262','64585','21494','72169',
                          '80924','85802','23818','25000','98702',
                          '39634','20197','51501','76002','38973',
                          '13677','22783','45470','18798','38721',
                          '65771','91395','98257','89452','95520',
                          '59462','97756','12699','50610','31923',
                          '85436','65423','39764','45042','75617',
                          '60720','63734','97496','63137','42171',
                          '67346','98715','62836','22012','42923',
                          '10249','86956','68004','48226','19975',
                          '49825','66064','38826','51222','71472',
                          '34615','23622','43940','18077','60742',
                          '51235','19599','20696','22573','70849',
                          '37251','86188','72643','87148','29251',
                          '50401','72791','85761','36825','10268',
                          '63047','54380','90818','88559')
     intersect
      select ca_zip
...
with ss as
 ...
 from store_sales,
      ...
      store
 where ss_sold_date_sk = d_date_sk
       and d_date between cast(date('2000-08-24') as date) 
                  and (cast(date('2000-08-24') as date) + interval '30' day) 
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
...
where 
	ss_item_sk = i_item_sk 
  	...
  	and ss_sold_date_sk = d_date_sk
	and d_date between cast(date('1998-06-29') as date) 
				and (cast(date('1998-06-29') as date) + interval '30' day)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('misty','forest','honeydew'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2000
 and     d_moy                   = 5
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast(date('1998-06-01') as date) and (cast(date('1998-06-01') as date) + interval '60' day)
 and i_manufact_id in (928,723,899,855)
 and inv_quantity_on_hand between 100 and 500
 and cs_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Cayuga County','Granite County','Washoe County','Ringgold County','Macon County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
select  *
 from(select w_warehouse_name
            ,i_item_id
            ,sum(case when (cast(d_date as date) < cast (date('2000-05-23') as date))
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between (cast (date('2000-05-23') as date) - interval '30' day)
                    and (cast (date('2000-05-23') as date) + interval '30' day)
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Highland','Milltown','Midway','Union','Hollywood') 
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in (date('2002-02-05'),date('2002-08-15'),date('2002-11-17'))))
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and (household_demographics.hd_dep_count = 4 or
             household_demographics.hd_vehicle_count= 1)
        and date_dim.d_year in (1998,1998+1,1998+2)
        and store.s_city in ('Columbia','Glenwood')
...
i_manufact_id = 305
and i_item_sk = ws_item_sk 
and d_date between date(date('1998-02-20')) and 
        (cast(date('1998-02-20') as date) + interval '90' day)
...
where 
	ws_item_sk = i_item_sk 
  	...
  	and ws_sold_date_sk = d_date_sk
	and d_date between cast(date('1999-06-20') as date) 
				and (cast(date('1999-06-20') as date) + interval '30' day)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('chiffon','pale','violet','magenta','antique','cream') and
...
select   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2001
 	and t_time between 55606 and 55606+28800 
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('NC', 'WV', 'VA')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('KY', 'TN', 'GA')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('IA', 'MN', 'NM')
...
select  
   w_state
  ,i_item_id
  ,sum(case when (cast(d_date as date) < cast (date('1998-02-23') as date)) 
 ...
 and cs_warehouse_sk    = w_warehouse_sk 
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast (date('1998-02-23') as date) - interval '30' day)
                and (cast (date('1998-02-23') as date) + interval '30' day) 
 group by
    w_state,i_item_id
...
and cc_county in ('Maverick County','Luce County','Mobile County','Daviess County',
                  'Mesa County'
)
and exists (select *
