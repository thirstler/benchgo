...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2001) and
        ((i_category in ('Sports','Electronics','Men') and
          i_class in ('archery','televisions','accessories')
         )
      or (i_category in ('Jewelry','Children','Books') and
          i_class in ('womens watch','infants','sports') 
        ))
...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast(date('2002-08-20') as date) 
                  and (cast(date('2002-08-20') as date) + interval '14' day)
...
with ssr as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast(date('2002-08-23') as date) 
                  and (cast(date('2002-08-23') as date) + interval '30' day)
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (3,8,1,2,7,11) and
       d_year = 2001 and
       ca_state in ('MS','VA','OR'
                   ,'SC','ND','IN','FL')
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('purple','mint','chartreuse'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2001
 and     d_moy                   = 3
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('GA', 'MI', 'TX')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('TN', 'AL', 'AR')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('WA', 'IL', 'MT')
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Hamilton'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  36753
   and ib_upper_bound   <=  36753 + 50000
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Scotts Bluff County','Henry County','Stutsman County','Real County','Louisa County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '76911','21637','79093','32385','68023','86869',
                          '33754','89423','27520','74334','74933',
                          '31158','28286','34927','71615','93397',
                          '10242','91518','21870','22388','54934',
                          '68844','51785','80083','43627','91225',
                          '47139','36313','58587','57520','33980',
                          '92533','17675','28263','16551','95582',
                          '98131','47983','67819','59949','45327',
                          '29967','92522','26733','74508','30979',
                          '54919','69642','48178','43275','14642',
                          '77111','41759','45814','36624','36453',
                          '49332','91962','48697','47114','89036',
                          '45043','10411','77824','88024','29770',
                          '84585','52488','85689','69851','83259',
                          '84077','88330','40241','41126','69234',
                          '31278','82304','90100','67618','72697',
                          '25933','30768','31489','25192','95483',
                          '28345','76827','85076','14924','22676',
                          '22168','26978','51302','49349','54544',
                          '68276','12444','64989','99096','73669',
                          '12907','30702','83068','27495','81702',
                          '81956','97243','37216','48847','43611',
                          '74221','46805','64151','15432','41269',
                          '44244','49537','50582','92616','48504',
                          '83757','46285','78584','17615','94114',
                          '32374','58873','48414','32576','87766',
                          '30009','28461','13591','85342','51059',
                          '48552','92924','70958','13249','85355',
                          '15022','39188','73670','66954','85836',
                          '83351','24112','48690','20905','70362',
                          '75432','31057','26467','13492','74976',
                          '44294','14571','55751','17303','85976',
                          '31273','19131','20091','80803','77405',
                          '29165','32702','74123','76554','77330',
                          '19391','71646','48287','66297','26483',
                          '44610','49024','33082','92872','67991',
                          '22321','95259','55549','44813','68559',
                          '29473','15948','73096','28706','35899',
                          '59362','64836','96218','50339','61529',
                          '86919','76148','52737','76940','77577',
                          '26078','20110','76122','58021','91804',
                          '41973','94279','67010','11313','59970',
                          '88586','14142','21111','26435','45695',
                          '65219','89897','44773','27261','73302',
                          '75348','25987','39507','25158','92367',
                          '54725','50575','43783','99789','63285',
                          '19018','60574','76661','78495','38733',
                          '85566','64930','44286','12807','39700',
                          '74736','73992','13659','58247','54440',
                          '85356','15371','21853','54101','65814',
                          '10524','33380','56659','30900','53933',
                          '57022','23532','34855','45891','20658',
                          '78341','94132','13913','37568','90531',
                          '11845','92635','37082','75439','44494',
                          '62767','20996','38112','14790','55682',
                          '35359','18707','90986','89475','37652',
                          '12654','90303','98173','17569','21557',
                          '40544','80181','49817','99325','39504',
                          '28741','28788','65379','21738','73214',
                          '27857','52503','61909','40097','44309',
                          '54729','58200','10775','85204','33840',
                          '56952','59680','35666','34763','82952',
                          '34980','96644','49463','12915','83578',
                          '42197','58203','74047','27953','16981',
                          '69692','61169','53217','79473','81988',
                          '49012','34876','68038','37303','65779',
                          '26718','21893','20066','80243','23828',
                          '53391','88316','82861','89351','43603',
                          '51454','33442','10144','22720','89736',
                          '95401','83146','14570','22464','27091',
                          '18912','87249','76986','74429','90575',
                          '84029','18165','88683','67031','90406',
                          '78668','36873','43419','70433','10015',
                          '30041','79334','52376','22149','11912',
                          '99189','84857','17444','54442','58629',
                          '44803','73368','66732','93744','70551',
                          '51243','23600','73914','94794','71173',
                          '31236','12854','46272','10975','29367',
                          '68475','23851','91099','89002','28181',
                          '35084','80446','10338','43234')
     intersect
      select ca_zip
...
select  i_item_id
 ...
 and d_date between cast(date('1998-01-09') as date) and (cast(date('1998-01-09') as date) + interval '60' day)
 and i_manufact_id in (920,865,997,980)
...
select   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2001
 	and t_time between 19063 and 19063+28800 
 	and sm_carrier in ('ALLIANCE','UPS')
     group by 
        w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
...
select  *
 from(select w_warehouse_name
            ,i_item_id
            ,sum(case when (cast(d_date as date) < cast (date('2000-03-02') as date))
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between (cast (date('2000-03-02') as date) - interval '30' day)
                    and (cast (date('2000-03-02') as date) + interval '30' day)
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast(date('2002-03-19') as date) and (cast(date('2002-03-19') as date) + interval '60' day)
 and i_manufact_id in (135,390,515,346)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Cross Roads','Needmore','Antioch','Riverdale','Pine Grove') 
...
select  distinct(i_product_name)
 ...
 where i_manufact_id between 909 and 909+40 
   and (select count(*) as item_cnt
        ...
        (i_color = 'cyan' or i_color = 'magenta') and 
        ...
        (i_category = 'Men' and
        (i_color = 'frosted' or i_color = 'sandy') and
...
select  
   w_state
  ,i_item_id
  ,sum(case when (cast(d_date as date) < cast (date('2000-03-05') as date)) 
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast (date('2000-03-05') as date) - interval '30' day)
                and (cast (date('2000-03-05') as date) + interval '30' day) 
 group by
    w_state,i_item_id
...
and cc_county in ('Daviess County','Wadena County','San Miguel County','Franklin Parish',
                  'Dauphin County'
)
and exists (select *
...
i_manufact_id = 741
and i_item_sk = ws_item_sk 
and d_date between date(date('1999-02-27')) and 
        (cast(date('1999-02-27') as date) + interval '90' day)
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Van Buren County','Huron County','Mobile County','West Feliciana Parish',
                           'Abbeville County','Harding County','Red River Parish','Mesa County')
...
select  c_last_name
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and date_dim.d_year in (2000,2000+1,2000+2)
        and store.s_city in ('Florence','Manchester')
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in (date('1999-06-25'),date('1999-08-06'),date('1999-11-04'))))
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 42 and 42+10 
             or ss_coupon_amt between 5811 and 5811+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 130 and 130+10
          or ss_coupon_amt between 13821 and 13821+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 145 and 145+10
          or ss_coupon_amt between 7 and 7+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 92 and 92+10
          or ss_coupon_amt between 9832 and 9832+1000
...
where 
	ws_item_sk = i_item_sk 
  	...
  	and ws_sold_date_sk = d_date_sk
	and d_date between cast(date('1999-02-21') as date) 
				and (cast(date('1999-02-21') as date) + interval '30' day)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('lime','forest','blush','violet','chartreuse','metallic') and
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 20844131
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 400667292
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 245474169
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 244948180
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 477118033
            then (select avg(ss_ext_discount_amt)
                  from store_sales
...
i_manufact_id = 37
and i_item_sk = cs_item_sk 
and d_date between date(date('2001-02-09')) and 
        (cast(date('2001-02-09') as date) + interval '90' day)
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (2000,2000+1,2000+2)
    and store.s_county in ('Oglethorpe County','Wadena County','Ziebach County','Dade County')
...
where 
	ss_item_sk = i_item_sk 
  	...
  	and ss_sold_date_sk = d_date_sk
	and d_date between cast(date('2000-04-30') as date) 
				and (cast(date('2000-04-30') as date) + interval '30' day)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
with ss as
 ...
 from store_sales,
      ...
      store
 where ss_sold_date_sk = d_date_sk
       and d_date between cast(date('2001-08-22') as date) 
                  and (cast(date('2001-08-22') as date) + interval '30' day) 
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
...
select  i_item_id
 ...
 from	catalog_sales
     ...
     ,date_dim
 where cs_item_sk = i_item_sk 
   and i_category in ('Sports', 'Books', 'Women')
   and cs_sold_date_sk = d_date_sk
 and d_date between cast(date('2001-01-29') as date) 
 				and (cast(date('2001-01-29') as date) + interval '30' day)
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
