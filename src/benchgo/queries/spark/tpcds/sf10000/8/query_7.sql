...
and d_date between date(date('2002-01-20')) and 
        (cast(date('2002-01-20') as date) + interval '90' day)
...
and d_date between date(date('2002-02-16')) and 
        (cast(date('2002-02-16') as date) + interval '90' day)
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('violet','tan','lace','antique','goldenrod','peru') and
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Mesa County','Wadena County','Miller County','Walker County',
                           'Terry County','Green Lake County','Jefferson Davis Parish','Williamson County')
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('TX', 'OK', 'OH')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('MS', 'OR', 'MO')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('ME', 'IL', 'WI')
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 145 and 145+10 
             or ss_coupon_amt between 5994 and 5994+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 97 and 97+10
          or ss_coupon_amt between 9423 and 9423+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 172 and 172+10
          or ss_coupon_amt between 16434 and 16434+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 189 and 189+10
          or ss_coupon_amt between 2088 and 2088+1000
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Crossroads'
   ...
   and ib_lower_bound   >=  14417
   and ib_upper_bound   <=  14417 + 50000
...
select  i_item_id
 ...
 where cs_item_sk = i_item_sk 
   ...
   and cs_sold_date_sk = d_date_sk
 and d_date between cast(date('2002-06-20') as date) 
 				and (cast(date('2002-06-20') as date) + interval '30' day)
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
select  *
 from(select w_warehouse_name
            ,i_item_id
            ,sum(case when (cast(d_date as date) < cast (date('2001-04-04') as date))
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between (cast (date('2001-04-04') as date) - interval '30' day)
                    and (cast (date('2001-04-04') as date) + interval '30' day)
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1999,1999+1,1999+2) 
    and store.s_city in ('Winchester','Lakewood','Hamilton','Eden','Forest Park') 
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Coffee County','Moultrie County','Meade County','McDowell County','Lincoln County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
select  i_item_id
 ...
 and d_date between cast(date('2000-02-20') as date) and (cast(date('2000-02-20') as date) + interval '60' day)
 and i_manufact_id in (773,863,844,943)
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 349574539
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 320092540
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 227912105
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 28855050
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 387365681
            then (select avg(ss_ext_tax)
                  from store_sales
...
select  
   w_state
  ,i_item_id
  ,sum(case when (cast(d_date as date) < cast (date('1999-03-20') as date)) 
 ...
 and cs_warehouse_sk    = w_warehouse_sk 
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast (date('1999-03-20') as date) - interval '30' day)
                and (cast (date('1999-03-20') as date) + interval '30' day) 
 group by
    w_state,i_item_id
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast(date('1999-04-25') as date) and (cast(date('1999-04-25') as date) + interval '60' day)
 and i_manufact_id in (174,754,843,995)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast(date('2001-08-28') as date) 
                  and (cast(date('2001-08-28') as date) + interval '14' day)
...
select  distinct(i_product_name)
 ...
 where i_manufact_id between 959 and 959+40 
   and (select count(*) as item_cnt
        ...
        (i_category = 'Men' and
        (i_color = 'puff' or i_color = 'chiffon') and
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Essex County','Lunenburg County','Jackson County','Wadena County')
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (1999) and
        ((i_category in ('Books','Children','Electronics') and
          i_class in ('business','infants','portable')
         )
      or (i_category in ('Women','Home','Music') and
          i_class in ('swimwear','mattresses','rock') 
        ))
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (1,3,8,9,7,5) and
       d_year = 2002 and
       ca_state in ('VA','NE','WY'
                   ,'MT','KS','NC','AL')
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('peru','cream','light'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2001
 and     d_moy                   = 7
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in (date('2001-01-25'),date('2001-09-13'),date('2001-11-16'))))
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '27067','36321','81939','33284','81504','32685',
                          '48655','82220','31077','67308','73454',
                          '79528','90688','99067','52164','28990',
                          '93133','93218','26513','34846','19517',
                          '75890','74641','92859','73464','25546',
                          '72146','92949','24555','64048','88354',
                          '70369','83167','44900','27327','13680',
                          '22028','50979','49446','71813','77263',
                          '24820','47047','38889','28246','15475',
                          '27483','19569','59024','77228','31493',
                          '19593','30098','35802','75405','51023',
                          '27848','93502','22441','95338','32811',
                          '42493','26164','22099','64042','66067',
                          '67701','98952','73606','51448','58044',
                          '81134','81840','31195','75211','66194',
                          '70101','15557','64025','22430','51334',
                          '89126','19207','35900','74345','45512',
                          '84661','94347','97686','87628','66668',
                          '29002','92355','84762','89785','33291',
                          '19188','33068','39698','66238','15687',
                          '46291','43164','12905','15594','49999',
                          '53110','82146','19823','79370','95987',
                          '10127','46420','74232','36038','60442',
                          '48377','53960','82742','41559','26320',
                          '15419','23264','36581','44428','77498',
                          '77237','99606','79398','67196','55664',
                          '90720','54169','35884','24290','99421',
                          '34933','47469','63944','85506','42790',
                          '62393','30073','56357','10704','54885',
                          '22770','19367','89338','25553','41747',
                          '49674','77225','53488','32873','22899',
                          '52076','80634','24119','66058','69910',
                          '78888','51771','73009','82841','79554',
                          '97427','28299','24177','27402','97666',
                          '42672','59867','26714','41866','80160',
                          '72990','17632','65331','72429','38038',
                          '81410','98806','65438','80627','84761',
                          '70033','11225','31383','58158','52561',
                          '83195','71760','71244','78566','86785',
                          '45099','71693','72563','92218','50006',
                          '24505','30175','47938','90600','63866',
                          '30618','86661','30619','59016','75634',
                          '57974','38028','77202','25933','28868',
                          '15534','25200','13084','62064','36779',
                          '23073','42709','53384','44322','66103',
                          '60558','64768','59231','96472','50344',
                          '75287','24339','40094','75356','63939',
                          '53499','14717','21457','87198','68258',
                          '72593','71695','58300','27388','72042',
                          '17351','90121','86614','63476','51452',
                          '53125','83166','57522','58495','62448',
                          '62240','49640','42975','36583','41901',
                          '98621','56226','55250','89813','60132',
                          '51762','26626','10368','12878','25722',
                          '25318','90013','56377','49067','38091',
                          '36916','34201','31424','85424','49443',
                          '59169','53648','10678','77171','15937',
                          '65517','42998','84406','68160','94546',
                          '73627','74902','64008','42642','43943',
                          '35121','28597','60180','38125','87255',
                          '50975','94135','84238','18691','91311',
                          '70677','40344','74347','20141','83533',
                          '45881','40628','83176','75101','70417',
                          '93143','94755','10763','49289','88760',
                          '83375','55437','85950','36329','39006',
                          '64874','54190','53446','53276','33203',
                          '43139','37065','91580','22005','52396',
                          '35381','30462','33676','48644','15022',
                          '43629','25196','29673','93237','24809',
                          '57000','92475','53460','34099','29291',
                          '30000','27360','36811','55074','15107',
                          '68522','65697','24546','65632','33933',
                          '47114','74508','17111','84786','14239',
                          '19334','63345','67806','65885','54314',
                          '76402','72243','91021','89047','21605',
                          '87418','46294','53437','15683','74189',
                          '84530','54189','46262','54439','87522',
                          '54129','47617','13770','48809','34796',
                          '79081','43608','62840','20336','12378',
                          '58803','96310','38721','57716')
     intersect
      select ca_zip
...
where 
	ws_item_sk = i_item_sk 
  	...
  	and ws_sold_date_sk = d_date_sk
	and d_date between cast(date('2001-04-20') as date) 
				and (cast(date('2001-04-20') as date) + interval '30' day)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select  c_last_name
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and date_dim.d_year in (1998,1998+1,1998+2)
        and store.s_city in ('Sherwood Forest','Riverdale')
...
select   
 ...
 from (
 	...
 	,w_state
 	,w_country
 	,'BOXBUNDLES' || ',' || 'DHL' as ship_carriers
       ,d_year as year
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2001
 	and t_time between 27822 and 27822+28800 
 	and sm_carrier in ('BOXBUNDLES','DHL')
     group by 
        w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
...
with ss as
 ...
 from store_sales,
      ...
      store
 where ss_sold_date_sk = d_date_sk
       and d_date between cast(date('2002-08-28') as date) 
                  and (cast(date('2002-08-28') as date) + interval '30' day) 
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
...
and cc_county in ('Huron County','Barrow County','Bronx County','Luce County',
                  'Raleigh County'
)
and exists (select *
