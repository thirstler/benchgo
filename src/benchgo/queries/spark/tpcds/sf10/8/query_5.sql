...
select   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2000
 	and t_time between 36293 and 36293+28800 
...
where 
	ss_item_sk = i_item_sk 
  	...
  	and ss_sold_date_sk = d_date_sk
	and d_date between cast(date('2002-01-15') as date) 
				and (cast(date('2002-01-15') as date) + interval '30' day)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('MO', 'TX', 'GA')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('IA', 'ID', 'VA')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('ND', 'CO', 'AL')
...
select  *
 from(select w_warehouse_name
            ,i_item_id
            ,sum(case when (cast(d_date as date) < cast (date('2001-05-04') as date))
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between (cast (date('2001-05-04') as date) - interval '30' day)
                    and (cast (date('2001-05-04') as date) + interval '30' day)
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('goldenrod','plum','lawn'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2000
 and     d_moy                   = 6
...
and d_date between date(date('1999-02-04')) and 
        (cast(date('1999-02-04') as date) + interval '90' day)
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 43 and 43+10 
             or ss_coupon_amt between 2200 and 2200+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 170 and 170+10
          or ss_coupon_amt between 7252 and 7252+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 18 and 18+10
          or ss_coupon_amt between 16001 and 16001+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 158 and 158+10
          or ss_coupon_amt between 9343 and 9343+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 146 and 146+10
          or ss_coupon_amt between 14094 and 14094+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 14 and 14+10
          or ss_coupon_amt between 7955 and 7955+1000
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (6,4,1,7,3,5) and
       d_year = 2000 and
       ca_state in ('LA','MA','IA'
                   ,'ID','WY','GA','TX')
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '75583','98873','63124','79239','23068','42661',
                          '68750','39567','78938','54372','31025',
                          '97263','90455','79805','79373','33137',
                          '94316','27570','64332','80591','98388',
                          '87234','74838','66029','47506','98505',
                          '88035','89515','84918','94676','72939',
                          '34983','37408','96713','90261','45901',
                          '71094','87446','37765','37352','60181',
                          '80100','12982','59727','81279','85067',
                          '12844','28805','53689','74645','36991',
                          '61388','70997','34568','64490','95713',
                          '70286','70033','84065','75596','60249',
                          '13838','87375','62845','96959','12177',
                          '26786','63019','73550','40100','28244',
                          '61917','32074','72161','54501','17238',
                          '23906','52133','94037','86733','77514',
                          '45284','59754','77804','83286','71044',
                          '89945','17138','77406','63809','45140',
                          '12774','51550','96876','39155','18853',
                          '76058','79905','87530','13326','10687',
                          '71468','64323','82623','61966','34684',
                          '56264','12615','36400','49882','10783',
                          '26447','85419','27125','74080','94338',
                          '36655','11572','46256','36807','84097',
                          '96701','43959','28641','60037','45622',
                          '17251','48392','82422','77224','90263',
                          '63796','92013','24811','90555','26100',
                          '43480','22547','51320','70992','14929',
                          '79268','89551','42592','59000','55193',
                          '77056','42692','44450','45811','14294',
                          '70604','31272','86614','46831','94951',
                          '84234','41320','19194','70946','15268',
                          '79842','85289','79291','68983','49473',
                          '32591','12363','30904','12350','83098',
                          '37552','90528','40976','26902','64717',
                          '46356','69564','40964','58524','87512',
                          '32349','59960','63062','94994','61005',
                          '23549','87438','23079','10734','62231',
                          '76683','98094','62336','27363','85405',
                          '59132','47872','26774','44139','42635',
                          '38222','57259','20241','53196','61949',
                          '20538','67709','50524','60388','10985',
                          '60653','29333','49911','20903','24812',
                          '62749','85932','16102','27785','48416',
                          '20124','95234','31555','13414','95946',
                          '10890','49886','10074','15478','84041',
                          '23834','73821','75203','55502','75806',
                          '98234','89719','52821','29526','73384',
                          '11005','83682','56736','20251','25708',
                          '89984','17930','85541','17863','61224',
                          '65173','81870','83454','11167','27254',
                          '45279','17388','37504','67668','15822',
                          '24543','45523','70718','55458','48862',
                          '31624','49825','67378','58647','25473',
                          '99113','50897','73535','91333','96018',
                          '21349','50527','16524','20487','61442',
                          '85486','72603','35238','24236','15057',
                          '15104','72752','25928','53260','34156',
                          '69958','81203','40391','19241','99350',
                          '25517','55129','38327','86344','71999',
                          '30365','80002','66373','14394','43946',
                          '79153','81983','77410','93618','80405',
                          '92923','63606','81027','82544','34584',
                          '44094','14255','96071','74631','12746',
                          '58206','38794','11034','15402','52652',
                          '21663','36017','91170','29612','95516',
                          '41104','24973','90145','95473','67326',
                          '85659','52722','85494','97123','71242',
                          '38823','47673','94796','51808','17713',
                          '64538','99451','66938','43405','12286',
                          '44920','57604','32537','71177','61491',
                          '77023','82339','43017','84920','41590',
                          '53482','16244','36354','83455','56061',
                          '36629','41943','73520','28470','51838',
                          '58049','38066','49555','41361','67533',
                          '63398','88813','62064','75603','19602',
                          '97293','37307','79035','69396','24500',
                          '93971','11637','43160','47490','10741',
                          '83959','11928','99014','82013','44964',
                          '65223','35814','43667','54902')
     intersect
      select ca_zip
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1998,1998+1,1998+2) 
    and store.s_city in ('Oak Grove','Fairview','Pleasant Hill','Midway','Riverside') 
...
and d_date between date(date('1998-01-22')) and 
        (cast(date('1998-01-22') as date) + interval '90' day)
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Deerfield'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  58635
   and ib_upper_bound   <=  58635 + 50000
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2001) and
        ((i_category in ('Books','Men','Shoes') and
          i_class in ('fiction','pants','mens')
         )
      or (i_category in ('Jewelry','Home','Children') and
          i_class in ('estate','tables','infants') 
        ))
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in (date('2002-06-15'),date('2002-09-15'),date('2002-11-08'))))
...
select  
   w_state
  ,i_item_id
  ,sum(case when (cast(d_date as date) < cast (date('2000-04-21') as date)) 
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast (date('2000-04-21') as date) - interval '30' day)
                and (cast (date('2000-04-21') as date) + interval '30' day) 
 group by
    w_state,i_item_id
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('seashell','honeydew','blue','burnished','dark','azure') and
...
select  i_item_id
 ...
 from	catalog_sales
     ...
     ,date_dim
 where cs_item_sk = i_item_sk 
   and i_category in ('Electronics', 'Children', 'Women')
   and cs_sold_date_sk = d_date_sk
 and d_date between cast(date('2001-05-05') as date) 
 				and (cast(date('2001-05-05') as date) + interval '30' day)
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast(date('1999-08-27') as date) 
                  and (cast(date('1999-08-27') as date) + interval '14' day)
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Tate County','Lucas County','Jones County','Upshur County','Lake County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
where 
	ws_item_sk = i_item_sk 
  	and i_category in ('Women', 'Home', 'Electronics')
  	and ws_sold_date_sk = d_date_sk
	and d_date between cast(date('1999-05-18') as date) 
				and (cast(date('1999-05-18') as date) + interval '30' day)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select  i_item_id
 ...
 and d_date between cast(date('1999-01-08') as date) and (cast(date('1999-01-08') as date) + interval '60' day)
 and i_manufact_id in (719,970,906,799)
...
select  distinct(i_product_name)
 ...
 where i_manufact_id between 725 and 725+40 
   and (select count(*) as item_cnt
        ...
        (i_category = 'Women' and
        (i_color = 'pale' or i_color = 'lavender') and
       ...
       (i_manufact = i1.i_manufact and
        ...
        (i_category = 'Women' and
        (i_color = 'red' or i_color = 'blush') and
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 365254
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 174260
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 195342
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 220470
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 361933
            then (select avg(ss_ext_tax)
                  from store_sales
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast(date('2001-01-20') as date) and (cast(date('2001-01-20') as date) + interval '60' day)
 and i_manufact_id in (961,910,647,513)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
