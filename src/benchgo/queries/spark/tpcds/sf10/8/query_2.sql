...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('peru','chiffon','navy'))
...
where 
	ss_item_sk = i_item_sk 
  	...
  	and ss_sold_date_sk = d_date_sk
	and d_date between cast(date('1998-02-17') as date) 
				and (cast(date('1998-02-17') as date) + interval '30' day)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast(date('1999-08-12') as date) 
                  and (cast(date('1999-08-12') as date) + interval '14' day)
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in (date('2002-02-16'),date('2002-08-02'),date('2002-11-09'))))
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 67 and 67+10
          or ss_coupon_amt between 5824 and 5824+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 140 and 140+10
          or ss_coupon_amt between 8393 and 8393+1000
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '27221','74380','62504','20449','55175','95222',
                          '70126','38261','47647','90123','68653',
                          '53851','81815','60106','57080','24811',
                          '61803','95892','46658','49365','16128',
                          '23386','85409','35406','99615','75459',
                          '61131','30927','97309','15226','84076',
                          '18363','76721','29014','23496','37012',
                          '39002','17399','78018','67452','54983',
                          '56832','70597','58020','42874','11163',
                          '55791','35590','58035','63538','70216',
                          '19372','74456','24649','58607','79093',
                          '35687','97727','86583','92343','34379',
                          '58941','52695','92487','66354','62824',
                          '92679','54831','15223','90074','87183',
                          '56039','43244','43524','25638','77559',
                          '70718','71068','39717','53629','84902',
                          '66628','34374','80688','29735','86132',
                          '78657','52661','19710','73782','64343',
                          '99688','30134','75384','30817','57428',
                          '11881','75334','31329','60358','43507',
                          '83360','42342','67935','65877','43288',
                          '36683','38607','32124','69679','98560',
                          '93317','63115','52852','50368','93971',
                          '11887','58411','28255','66882','77330',
                          '68961','49269','18677','12305','84491',
                          '23299','94814','98202','11128','71061',
                          '54253','29339','15225','68403','17666',
                          '48531','55516','11100','17351','68229',
                          '81141','52890','33462','47796','74346',
                          '79720','48971','23988','74352','71587',
                          '10960','95597','89106','58002','15385',
                          '60760','21555','40330','76052','55558',
                          '74905','66587','44707','93143','70506',
                          '69045','69142','37796','19281','15024',
                          '99414','50742','57792','88320','19669',
                          '96568','25694','69480','79370','32353',
                          '69190','16998','60509','92237','35311',
                          '85245','39265','57452','45403','51762',
                          '92498','68633','85088','91199','60999',
                          '92523','89151','92998','38850','81189',
                          '58141','51474','85282','13672','29053',
                          '60587','97087','43853','53095','47043',
                          '70341','95396','53747','88622','16767',
                          '25630','48776','80467','97838','23750',
                          '88572','68386','94745','51103','43067',
                          '12253','67555','73830','40186','87905',
                          '70859','77966','94326','51586','77571',
                          '33575','46343','71975','28667','44872',
                          '53494','38267','68350','48046','21066',
                          '82521','67296','22022','60767','37339',
                          '73887','67521','79950','57454','78776',
                          '87087','26793','67845','94521','14694',
                          '76502','85613','63586','82172','32815',
                          '86074','25355','47651','59486','49458',
                          '66175','88755','43359','91170','44488',
                          '88081','86071','86314','33920','42784',
                          '43588','14485','56221','93184','71849',
                          '94115','94815','66651','61228','40048',
                          '43423','61815','64182','79737','54438',
                          '99339','20388','45783','26714','81376',
                          '53855','36714','49580','53098','15968',
                          '72987','90994','81401','54307','48694',
                          '88431','42634','53690','89622','11578',
                          '81004','23495','41539','43427','52216',
                          '61470','53451','49021','91712','97146',
                          '63687','97638','86275','69955','13922',
                          '71466','11206','18513','59231','10283',
                          '27840','62869','61329','76262','13259',
                          '97642','55922','13157','57347','82480',
                          '92888','11957','37497','52690','76872',
                          '92813','10995','49218','41687','23672',
                          '47521','21597','90512','46732','50309',
                          '40644','76255','26909','14301','39619',
                          '10353','62739','53147','48762','81750',
                          '98544','28030','87016','77136','97753',
                          '49090','14317','39125','62582','36089',
                          '34105','83454','68448','80480','95233',
                          '77060','41156','68718','45748','41056',
                          '10125','10318','31458','34098','46164',
                          '30152','81029','63854','18248')
     intersect
      select ca_zip
...
select  *
 from(select w_warehouse_name
            ,i_item_id
            ,sum(case when (cast(d_date as date) < cast (date('2002-04-16') as date))
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between (cast (date('2002-04-16') as date) - interval '30' day)
                    and (cast (date('2002-04-16') as date) + interval '30' day)
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Montgomery County','Edwards County','Sevier County','Kanabec County','Greenbrier County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
select  i_item_id
 ...
 and d_date between cast(date('1999-02-19') as date) and (cast(date('1999-02-19') as date) + interval '60' day)
 and i_manufact_id in (338,205,218,526)
...
select  
   w_state
  ,i_item_id
  ,sum(case when (cast(d_date as date) < cast (date('2001-04-28') as date)) 
 ...
 and cs_warehouse_sk    = w_warehouse_sk 
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast (date('2001-04-28') as date) - interval '30' day)
                and (cast (date('2001-04-28') as date) + interval '30' day) 
 group by
    w_state,i_item_id
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Pine Grove'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  55081
   and ib_upper_bound   <=  55081 + 50000
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast(date('2002-06-30') as date) and (cast(date('2002-06-30') as date) + interval '60' day)
 and i_manufact_id in (941,836,839,989)
 and inv_quantity_on_hand between 100 and 500
 and cs_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
where 
	ws_item_sk = i_item_sk 
  	...
  	and ws_sold_date_sk = d_date_sk
	and d_date between cast(date('2001-06-18') as date) 
				and (cast(date('2001-06-18') as date) + interval '30' day)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('dark','honeydew','green','tan','cornflower','spring') and
...
select  i_item_id
 ...
 where cs_item_sk = i_item_sk 
   ...
   and cs_sold_date_sk = d_date_sk
 and d_date between cast(date('2001-04-28') as date) 
 				and (cast(date('2001-04-28') as date) + interval '30' day)
 group by i_item_id
         ,i_item_desc 
         ,i_category
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 212732
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 428117
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 150770
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 409720
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 393867
            then (select avg(ss_ext_sales_price)
                  from store_sales
...
i_manufact_id = 6
and i_item_sk = cs_item_sk 
and d_date between date(date('2001-02-03')) and 
        (cast(date('2001-02-03') as date) + interval '90' day)
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (2,1,7,11,5,12) and
       d_year = 1998 and
       ca_state in ('CA','TX','TN'
                   ,'VA','AK','MN','NJ')
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('WI', 'MS', 'TX')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('NC', 'CO', 'ME')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('NE', 'WA', 'IN')
...
i_manufact_id = 365
and i_item_sk = ws_item_sk 
and d_date between date(date('2001-03-18')) and 
        (cast(date('2001-03-18') as date) + interval '90' day)
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2001) and
        ((i_category in ('Sports','Men','Women') and
          i_class in ('sailing','shirts','swimwear')
         )
      or (i_category in ('Jewelry','Books','Music') and
          i_class in ('mens watch','parenting','classical') 
        ))
...
select   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2001
 	and t_time between 15516 and 15516+28800 
