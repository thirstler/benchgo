...
select  distinct(i_product_name)
 ...
 where i_manufact_id between 933 and 933+40 
   and (select count(*) as item_cnt
        ...
        (i_category = 'Women' and
        (i_color = 'coral' or i_color = 'blanched') and
        (i_units = 'Gross' or i_units = 'Pallet') and
        (i_size = 'petite' or i_size = 'N/A')
        ) or
        (i_category = 'Men' and
        (i_color = 'lavender' or i_color = 'tan') and
...
and d_date between date(date('1998-01-14')) and 
        (cast(date('1998-01-14') as date) + interval '90' day)
...
select   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 1999
 	and t_time between 48215 and 48215+28800 
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Forest Hills'
   ...
   and ib_lower_bound   >=  27898
   and ib_upper_bound   <=  27898 + 50000
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '68919','88234','86932','13781','15091','13313',
                          '70886','19033','71725','39035','88982',
                          '80536','26368','53199','88004','80640',
                          '12492','81808','26180','76519','22236',
                          '36806','24301','62542','15197','68418',
                          '82592','41479','79183','68804','31349',
                          '81587','78355','47555','96460','36940',
                          '61509','93320','60318','49661','71483',
                          '42419','59430','12255','75897','97841',
                          '23312','67227','24806','89178','49902',
                          '42819','70182','13785','59174','98385',
                          '32855','10044','21486','84762','36670',
                          '79898','59916','91365','75883','31792',
                          '15083','79052','91119','57621','80966',
                          '90537','61294','16712','81674','40807',
                          '85478','56836','60106','86658','86708',
                          '48019','57202','81982','37473','22706',
                          '11254','90955','79478','54268','56565',
                          '54684','29264','19723','99892','28984',
                          '61383','19273','77078','65083','16665',
                          '68021','25069','83992','65288','51178',
                          '89947','35959','80129','66649','47350',
                          '55868','19290','23502','64303','67474',
                          '58956','82189','55177','60141','79559',
                          '80435','38141','36187','23343','18260',
                          '29538','73992','69242','64234','79785',
                          '74962','39715','32415','52414','21462',
                          '53048','28028','73436','29817','76343',
                          '63888','23078','70560','74934','40939',
                          '41403','23496','56640','74587','30011',
                          '33544','51153','58520','62702','96269',
                          '89029','53327','36057','80266','69806',
                          '47305','97746','70326','94394','53169',
                          '42442','37327','20780','77815','89468',
                          '85918','75993','15527','27583','60232',
                          '83463','95249','44875','21001','53283',
                          '76255','69640','86075','81155','34140',
                          '83622','31120','63333','52406','49569',
                          '16113','82362','84147','34212','68493',
                          '80959','66769','60920','40797','97890',
                          '80295','66612','33771','33345','50087',
                          '71809','76148','22954','42682','26640',
                          '91280','72790','66761','50841','29960',
                          '10844','26807','23981','64200','77982',
                          '25524','27094','22514','37037','84363',
                          '65190','38115','58266','44962','11548',
                          '96435','44343','52273','33487','34274',
                          '26106','35530','59258','12276','55001',
                          '91283','72381','72881','71940','10529',
                          '92511','51426','17262','98211','57681',
                          '49438','47970','32792','56317','18650',
                          '13931','66747','55612','91642','45529',
                          '10036','52497','23538','60697','13047',
                          '34827','94899','97142','60113','15285',
                          '57789','33694','94518','79774','22157',
                          '28520','16325','31518','83171','92993',
                          '67207','18472','81580','22859','96105',
                          '71975','36517','67213','93356','15249',
                          '79198','37205','74059','53027','75888',
                          '44781','90104','65759','77018','46067',
                          '85077','70693','13252','89997','56480',
                          '67894','35870','67188','67759','62147',
                          '46705','23122','43289','84396','37576',
                          '60573','96824','71139','92445','78676',
                          '40303','30356','95616','34371','85156',
                          '14995','38980','88947','42935','20392',
                          '50900','40171','60319','94577','34748',
                          '81519','69677','86968','34484','62874',
                          '45671','94395','30405','19923','77316',
                          '67314','47549','50363','26879','48037',
                          '80370','11897','28573','70447','64243',
                          '82063','62698','25808','27749','82978',
                          '87811','58169','36545','10841','88082',
                          '76443','32706','66189','79145','16647',
                          '50800','33874','68255','20389','46985',
                          '69398','59731','65959','81415','48862',
                          '81951','53666','56453','88028','39432',
                          '12800','36960','72851','33433','67648',
                          '40284','36174','32176','83028','23895',
                          '97184','94936','82288','78549')
     intersect
      select ca_zip
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2000) and
        ((i_category in ('Jewelry','Men','Music') and
          i_class in ('jewelry boxes','accessories','pop')
         )
      or (i_category in ('Home','Books','Children') and
          i_class in ('mattresses','science','toddlers') 
        ))
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in (date('2001-06-11'),date('2001-08-24'),date('2001-11-13'))))
...
select  *
 from(select w_warehouse_name
            ,i_item_id
            ,sum(case when (cast(d_date as date) < cast (date('1999-02-21') as date))
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between (cast (date('1999-02-21') as date) - interval '30' day)
...
select  
   w_state
  ,i_item_id
  ,sum(case when (cast(d_date as date) < cast (date('2001-05-14') as date)) 
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast (date('2001-05-14') as date) - interval '30' day)
                and (cast (date('2001-05-14') as date) + interval '30' day) 
 group by
    w_state,i_item_id
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 173 and 173+10 
             or ss_coupon_amt between 5025 and 5025+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 40 and 40+10
          or ss_coupon_amt between 13227 and 13227+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 172 and 172+10
          or ss_coupon_amt between 17449 and 17449+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 19 and 19+10
          or ss_coupon_amt between 1025 and 1025+1000
...
with ss as
 ...
 from store_sales,
      ...
      store
 where ss_sold_date_sk = d_date_sk
       and d_date between cast(date('2001-08-11') as date) 
                  and (cast(date('2001-08-11') as date) + interval '30' day) 
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (2,4,10,8,7,3) and
       d_year = 2002 and
       ca_state in ('GA','NV','CO'
                   ,'IA','OH','MD','FL')
...
select  i_item_id
 ...
 and d_date between cast(date('2000-01-13') as date) and (cast(date('2000-01-13') as date) + interval '60' day)
 and i_manufact_id in (903,914,893,701)
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Gooding County','Kent County','Mono County','Coffey County','Pipestone County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
and d_date between date(date('1999-03-31')) and 
        (cast(date('1999-03-31') as date) + interval '90' day)
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast(date('1998-06-03') as date) and (cast(date('1998-06-03') as date) + interval '60' day)
 and i_manufact_id in (144,704,337,441)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('chiffon','light','orchid'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 1998
 and     d_moy                   = 7
...
where 
	ws_item_sk = i_item_sk 
  	...
  	and ws_sold_date_sk = d_date_sk
	and d_date between cast(date('1998-04-26') as date) 
				and (cast(date('1998-04-26') as date) + interval '30' day)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select  i_item_id
 ...
 where cs_item_sk = i_item_sk 
   ...
   and cs_sold_date_sk = d_date_sk
 and d_date between cast(date('2001-05-15') as date) 
 				and (cast(date('2001-05-15') as date) + interval '30' day)
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
where 
	ss_item_sk = i_item_sk 
  	...
  	and ss_sold_date_sk = d_date_sk
	and d_date between cast(date('1999-01-17') as date) 
				and (cast(date('1999-01-17') as date) + interval '30' day)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast(date('2000-08-11') as date) 
                  and (cast(date('2000-08-11') as date) + interval '14' day)
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('ghost','chartreuse','mint','gainsboro','slate','brown') and
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('GA', 'OK', 'ND')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('KY', 'VA', 'TX')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('PA', 'MA', 'OR')
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 108635
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 361591
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 410628
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 30485
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 419324
            then (select avg(ss_ext_tax)
                  from store_sales
