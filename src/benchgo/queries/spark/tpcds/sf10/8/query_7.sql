...
and d_date between date(date('1998-03-12')) and 
        (cast(date('1998-03-12') as date) + interval '90' day)
...
and d_date between date(date('1998-01-18')) and 
        (cast(date('1998-01-18') as date) + interval '90' day)
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('burlywood','indian','dim','salmon','bisque','lavender') and
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('TN', 'MO', 'MS')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('PA', 'FL', 'AR')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('SD', 'VT', 'NY')
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 51 and 51+10 
             or ss_coupon_amt between 2006 and 2006+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 60 and 60+10
          or ss_coupon_amt between 16014 and 16014+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 113 and 113+10
          or ss_coupon_amt between 7339 and 7339+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 64 and 64+10
          or ss_coupon_amt between 10285 and 10285+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 133 and 133+10
          or ss_coupon_amt between 5420 and 5420+1000
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Bunker Hill'
   ...
   and ib_lower_bound   >=  29519
   and ib_upper_bound   <=  29519 + 50000
...
where 
	ss_item_sk = i_item_sk 
  	...
  	and ss_sold_date_sk = d_date_sk
	and d_date between cast(date('1998-01-21') as date) 
				and (cast(date('1998-01-21') as date) + interval '30' day)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
with ssr as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast(date('2000-08-16') as date) 
                  and (cast(date('2000-08-16') as date) + interval '30' day)
...
select  i_item_id
 ...
 where cs_item_sk = i_item_sk 
   ...
   and cs_sold_date_sk = d_date_sk
 and d_date between cast(date('2002-05-22') as date) 
 				and (cast(date('2002-05-22') as date) + interval '30' day)
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
select  *
 from(select w_warehouse_name
            ,i_item_id
            ,sum(case when (cast(d_date as date) < cast (date('2000-03-10') as date))
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between (cast (date('2000-03-10') as date) - interval '30' day)
                    and (cast (date('2000-03-10') as date) + interval '30' day)
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1998,1998+1,1998+2) 
    and store.s_city in ('Riverside','Pleasant Hill','Midway','Fairview','Oak Grove') 
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Roosevelt County','Greene County','Sheboygan County','Hodgeman County','Dinwiddie County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
select  i_item_id
 ...
 and d_date between cast(date('2002-03-05') as date) and (cast(date('2002-03-05') as date) + interval '60' day)
 and i_manufact_id in (889,841,895,969)
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 425225
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 40863
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 256643
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 66971
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 176437
            then (select avg(ss_ext_discount_amt)
                  from store_sales
...
select  
   w_state
  ,i_item_id
  ,sum(case when (cast(d_date as date) < cast (date('1998-02-06') as date)) 
 ...
 and cs_warehouse_sk    = w_warehouse_sk 
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast (date('1998-02-06') as date) - interval '30' day)
                and (cast (date('1998-02-06') as date) + interval '30' day) 
 group by
    w_state,i_item_id
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast(date('1998-02-10') as date) and (cast(date('1998-02-10') as date) + interval '60' day)
 and i_manufact_id in (640,724,123,284)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
 ...
 where i_manufact_id between 899 and 899+40 
   and (select count(*) as item_cnt
       ...
       (i_manufact = i1.i_manufact and
        ...
        (i_category = 'Women' and
        (i_color = 'antique' or i_color = 'plum') and
...
where ss_item_sk = i_item_sk and
      ...
      ss_store_sk = s_store_sk and
      d_year in (2001) and
        ((i_category in ('Women','Children','Electronics') and
          i_class in ('dresses','newborn','audio')
         )
      or (i_category in ('Books','Jewelry','Men') and
          i_class in ('parenting','earings','shirts') 
        ))
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (8,6,7,1,2,3) and
       d_year = 2002 and
       ca_state in ('TX','TN','ID'
                   ,'PA','MO','IA','WY')
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('orchid','cornsilk','navajo'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 1999
 and     d_moy                   = 3
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in (date('2000-07-09'),date('2000-08-03'),date('2000-11-18'))))
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '25796','35287','15494','25949','61575','10692',
                          '69348','40364','98465','95453','49818',
                          '16170','60313','69354','54630','67046',
                          '47877','21866','33145','48876','57936',
                          '97859','30125','63748','92753','89271',
                          '80853','88516','28681','84050','95498',
                          '33738','37983','60132','35996','64841',
                          '73666','44169','92659','22920','38232',
                          '42107','35176','28023','65220','97261',
                          '27001','62634','95802','60021','89385',
                          '20028','46800','23672','83020','33993',
                          '58115','62102','97890','49175','23843',
                          '25817','47252','95047','98332','71229',
                          '39669','76199','69911','66756','28146',
                          '97411','25514','47156','27854','52506',
                          '79975','14516','13152','12134','50233',
                          '89990','32303','95912','52999','72091',
                          '74682','28169','65335','77392','15642',
                          '62657','85307','24081','54937','10874',
                          '55032','72230','74328','10332','21228',
                          '83209','47171','52477','80602','42044',
                          '98251','90148','36937','62230','66082',
                          '32750','21488','11921','62257','45413',
                          '33919','89336','33844','68903','24192',
                          '38037','30506','30715','86312','81342',
                          '81817','55103','99323','46969','81486',
                          '65600','35927','53297','53620','74049',
                          '38975','10623','78107','93449','86048',
                          '75745','12112','60687','46826','64934',
                          '89673','90302','15667','62087','30865',
                          '45448','56085','97027','87863','24716',
                          '48928','57318','10693','56746','77903',
                          '46989','40128','91322','74256','19108',
                          '27728','55134','47984','47440','99250',
                          '94209','47473','81545','82247','18736',
                          '42203','21936','10686','83130','71353',
                          '92575','72310','84023','51746','61578',
                          '49664','80827','55460','39845','13286',
                          '31921','67469','30052','31279','14517',
                          '31730','29366','58716','93830','36490',
                          '51635','38209','89211','39615','56943',
                          '45578','83843','17563','91226','67301',
                          '98254','12178','76062','96534','84906',
                          '32114','72874','75397','50255','72405',
                          '75451','14408','37248','84343','14685',
                          '30852','56571','13646','42097','13253',
                          '54885','76969','15149','28659','93686',
                          '97216','97774','96327','83207','48395',
                          '20474','86976','35245','43703','24766',
                          '26810','21578','23586','11808','79063',
                          '44756','48722','23094','52078','96979',
                          '96555','91457','81260','41122','75900',
                          '15391','74989','85180','50486','13653',
                          '96784','88178','98636','38784','69593',
                          '33637','59213','13978','28016','90975',
                          '31393','48261','45942','43670','33772',
                          '35990','79151','88540','87917','87726',
                          '54976','38429','15303','99039','90622',
                          '86857','90962','88403','89606','19346',
                          '56281','66099','38810','39053','19650',
                          '32729','88625','96307','71498','50333',
                          '87323','13649','55429','73924','26711',
                          '80121','36263','35621','34259','96195',
                          '32218','62990','78877','75803','36868',
                          '89261','36162','18396','45280','33484',
                          '81636','29223','45542','96039','71013',
                          '35554','56233','31920','46002','85627',
                          '22828','15812','42269','46788','85324',
                          '94023','48535','31860','99617','78527',
                          '68575','48510','23801','98186','82145',
                          '27641','17811','56069','66568','55126',
                          '31076','93689','99593','64936','65151',
                          '30699','52561','41408','78060','44996',
                          '25005','49597','16697','11702','13749',
                          '35688','74577','62807','18593','19749',
                          '65997','67638','20163','66117','62555',
                          '95286','85304','95788','48153','13976',
                          '79119','73493','18140','70022','45285',
                          '48451','27127','23260','19964','68853',
                          '34360','64479','71275','10466')
     intersect
      select ca_zip
...
where 
	ws_item_sk = i_item_sk 
  	and i_category in ('Electronics', 'Music', 'Jewelry')
  	and ws_sold_date_sk = d_date_sk
	and d_date between cast(date('2000-06-13') as date) 
...
select   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 1998
 	and t_time between 26637 and 26637+28800 
 	and sm_carrier in ('UPS','ZOUROS')
     group by 
        w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
...
with ss as
 ...
 from store_sales,
      ...
      store
 where ss_sold_date_sk = d_date_sk
       and d_date between cast(date('1999-08-14') as date) 
                  and (cast(date('1999-08-14') as date) + interval '30' day) 
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
