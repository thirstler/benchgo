...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in (date('1999-07-06'),date('1999-08-29'),date('1999-11-22'))))
...
and d_date between date(date('1999-03-03')) and 
        (cast(date('1999-03-03') as date) + interval '90' day)
...
and d_date between date(date('2002-01-10')) and 
        (cast(date('2002-01-10') as date) + interval '90' day)
...
select   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 1999
 	and t_time between 21698 and 21698+28800 
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Fairview'
   ...
   and ib_lower_bound   >=  22705
   and ib_upper_bound   <=  22705 + 50000
...
where 
	ss_item_sk = i_item_sk 
  	and i_category in ('Electronics', 'Women', 'Jewelry')
  	and ss_sold_date_sk = d_date_sk
	and d_date between cast(date('2000-02-24') as date) 
				and (cast(date('2000-02-24') as date) + interval '30' day)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
with ss as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast(date('1999-08-10') as date) 
                  and (cast(date('1999-08-10') as date) + interval '30' day) 
...
select  
   w_state
  ,i_item_id
  ,sum(case when (cast(d_date as date) < cast (date('2000-07-01') as date)) 
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast (date('2000-07-01') as date) - interval '30' day)
                and (cast (date('2000-07-01') as date) + interval '30' day) 
 group by
    w_state,i_item_id
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('IL', 'CO', 'TN')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('VA', 'AL', 'NE')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('MO', 'TX', 'VT')
...
where 
	ws_item_sk = i_item_sk 
  	...
  	and ws_sold_date_sk = d_date_sk
	and d_date between cast(date('2001-04-24') as date) 
				and (cast(date('2001-04-24') as date) + interval '30' day)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 175 and 175+10 
             or ss_coupon_amt between 6302 and 6302+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 75 and 75+10
          or ss_coupon_amt between 16828 and 16828+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 64 and 64+10
          or ss_coupon_amt between 3461 and 3461+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 150 and 150+10
          or ss_coupon_amt between 9951 and 9951+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 182 and 182+10
          or ss_coupon_amt between 10422 and 10422+1000
 ...
 where i_manufact_id between 980 and 980+40 
   and (select count(*) as item_cnt
       ...
       (i_manufact = i1.i_manufact and
        ((i_category = 'Women' and 
        (i_color = 'wheat' or i_color = 'lavender') and 
        ...
        (i_category = 'Men' and
        (i_color = 'cream' or i_color = 'thistle') and
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '73600','72056','22548','91783','90906','88565',
                          '27876','24441','87289','73552','17278',
                          '10431','24160','79925','99638','44637',
                          '62219','74970','94827','42857','38532',
                          '11294','59801','18467','31666','72905',
                          '99181','20926','12169','44854','47373',
                          '64002','50011','69012','61153','42742',
                          '43729','88426','79356','47095','92613',
                          '57978','98313','99686','94582','20043',
                          '42377','24526','87913','41063','13528',
                          '70536','74836','49915','75653','89861',
                          '78485','50243','81175','27654','96100',
                          '53629','71412','31503','26130','42264',
                          '66015','94673','83035','37837','76834',
                          '87532','11564','64904','39365','22717',
                          '92434','70799','60011','89267','13958',
                          '29023','85879','88529','30936','80671',
                          '77826','92903','98435','76511','45737',
                          '72927','61787','36933','42600','53283',
                          '62255','80583','91148','56608','95057',
                          '10154','93521','50957','91312','82769',
                          '29195','83086','91281','35079','87985',
                          '15442','88961','24967','88091','43115',
                          '96603','41634','89209','12636','51739',
                          '28811','66196','97120','71948','75646',
                          '85455','16207','10210','28475','66925',
                          '90433','66535','30044','34826','85451',
                          '22033','22942','63840','45738','70715',
                          '78848','78130','82788','66812','92631',
                          '62815','93899','75513','67952','66071',
                          '99143','32644','63835','45884','86715',
                          '90746','49143','62676','81918','35633',
                          '40591','15327','81872','59829','53676',
                          '87137','61395','62478','84778','58477',
                          '41652','52817','63190','96898','88274',
                          '88195','17393','88261','32804','94895',
                          '42489','35883','32134','11945','87972',
                          '63677','89863','24948','50140','94179',
                          '10382','88522','95804','22962','34880',
                          '39759','48598','22240','88083','15017',
                          '10693','25560','74639','85411','15189',
                          '91017','75812','31634','65585','88792',
                          '24219','90588','22499','53599','25469',
                          '89111','27071','72033','31721','53115',
                          '84683','26369','17298','54837','96379',
                          '44628','20738','97292','54276','23054',
                          '51569','30842','19713','15753','51409',
                          '89976','29534','60204','41472','89495',
                          '65398','75068','40809','59419','62811',
                          '38506','93233','86263','87807','77666',
                          '81038','69415','82579','84916','53518',
                          '25493','79089','63762','65022','22269',
                          '27104','26699','31395','56155','37881',
                          '12682','84071','15527','51595','57229',
                          '64860','63956','97948','15904','31180',
                          '26700','90138','72662','27036','93735',
                          '96791','87095','75806','68328','14111',
                          '99525','85677','35072','55987','63971',
                          '31181','75236','36276','40179','28751',
                          '57803','82285','64290','21156','76367',
                          '62773','42806','71106','55422','59700',
                          '65329','59616','40063','52612','64398',
                          '30866','39970','76021','88044','95836',
                          '29711','48741','60315','99710','11299',
                          '51826','96621','24636','99176','62885',
                          '18993','17192','35405','15456','59116',
                          '29162','95488','81227','29911','53490',
                          '24656','28766','94984','14164','52289',
                          '31222','36210','86580','68877','21412',
                          '42729','33628','11263','19742','98178',
                          '88605','21499','20473','56315','83066',
                          '32867','35995','25343','84047','59960',
                          '87222','50827','60207','74535','65511',
                          '39522','29186','13984','12466','62206',
                          '76654','82421','19675','27704','44474',
                          '44136','23412','67537','24593','71038',
                          '46922','27858','75043','53702','39458',
                          '79766','21515','95846','62598','77721',
                          '20893','55829','64681','70280','27658',
                          '95371','10137','98900','15390')
     intersect
      select ca_zip
...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast(date('1999-08-11') as date) 
                  and (cast(date('1999-08-11') as date) + interval '14' day)
...
select  i_item_id
 ...
 and d_date between cast(date('2001-01-23') as date) and (cast(date('2001-01-23') as date) + interval '60' day)
 and i_manufact_id in (414,271,364,763)
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (3,5,2,6,7,10) and
       d_year = 2000 and
       ca_state in ('TN','MT','NE'
                   ,'WV','MN','GA','NJ')
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 464790
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 403833
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 451402
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 376436
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 130998
            then (select avg(ss_ext_list_price)
                  from store_sales
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast(date('2002-06-14') as date) and (cast(date('2002-06-14') as date) + interval '60' day)
 and i_manufact_id in (937,973,818,688)
 and inv_quantity_on_hand between 100 and 500
 and cs_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
with ssr as
 (select  s_store_id as store_id,
  ...
  from store_sales left outer join store_returns on
     ...
     promotion
 where ss_sold_date_sk = d_date_sk
       and d_date between cast(date('1999-08-09') as date) 
                  and (cast(date('1999-08-09') as date) + interval '30' day)
       and ss_store_sk = s_store_sk
       and ss_item_sk = i_item_sk
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('medium','light','yellow','lawn','antique','spring') and
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Five Points','Pleasant Hill','Midway','Oak Grove','Riverside') 
...
select  *
 from(select w_warehouse_name
            ,i_item_id
            ,sum(case when (cast(d_date as date) < cast (date('2002-03-12') as date))
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between (cast (date('2002-03-12') as date) - interval '30' day)
                    and (cast (date('2002-03-12') as date) + interval '30' day)
...
select  i_item_id
 ...
 where cs_item_sk = i_item_sk 
   ...
   and cs_sold_date_sk = d_date_sk
 and d_date between cast(date('2001-06-05') as date) 
 				and (cast(date('2001-06-05') as date) + interval '30' day)
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2001) and
        ((i_category in ('Sports','Books','Men') and
          i_class in ('hockey','reference','accessories')
         )
      or (i_category in ('Home','Shoes','Children') and
          i_class in ('blinds/shades','kids','school-uniforms') 
        ))
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Lexington County','Norfolk city','Presque Isle County','Lincoln County','Lawrence County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('burlywood','coral','goldenrod'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 1999
 and     d_moy                   = 6
