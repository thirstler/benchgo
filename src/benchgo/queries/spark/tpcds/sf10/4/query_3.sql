...
where ss_item_sk = i_item_sk and
      ...
      d_year in (1999) and
        ((i_category in ('Shoes','Jewelry','Electronics') and
          i_class in ('womens','jewelry boxes','portable')
         )
      or (i_category in ('Music','Home','Sports') and
          i_class in ('country','lighting','hockey') 
        ))
...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast(date('2002-08-24') as date) 
                  and (cast(date('2002-08-24') as date) + interval '14' day)
...
with ssr as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast(date('2002-08-29') as date) 
                  and (cast(date('2002-08-29') as date) + interval '30' day)
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (8,1,7,3,6,9) and
       d_year = 2000 and
       ca_state in ('KS','OH','WI'
                   ,'IA','HI','GA','WV')
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('blanched','floral','black'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2000
 and     d_moy                   = 5
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('SD', 'TN', 'MO')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('NC', 'WY', 'GA')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('VA', 'MI', 'TX')
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Waterloo'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  57724
   and ib_upper_bound   <=  57724 + 50000
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Wood County','Liberty County','Lee County','Lander County','Glades County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '31552','19338','24801','60710','10647','84550',
                          '13886','55425','98353','10585','88508',
                          '94586','81212','29174','88959','47588',
                          '56772','90736','55194','12814','22558',
                          '54206','84452','55768','61865','94480',
                          '58323','41557','60699','84001','40548',
                          '29469','88343','73535','68555','29647',
                          '89769','69358','35872','33318','80969',
                          '33601','79082','20036','54874','33168',
                          '62377','48265','21081','16671','77545',
                          '66838','62453','16336','37606','27642',
                          '91275','90818','29905','55936','33114',
                          '94918','75560','62229','20625','17968',
                          '58345','20378','63959','61202','28444',
                          '40932','59587','94110','32076','60785',
                          '93550','91214','59398','70378','92169',
                          '15226','27377','49749','26529','54508',
                          '54833','92886','43553','90318','82152',
                          '23546','86019','26300','80346','40278',
                          '90114','22632','51861','89786','48175',
                          '22170','67592','82235','29517','50520',
                          '61289','32527','13093','52463','18132',
                          '13070','48482','74638','19073','95799',
                          '50377','20099','82431','32883','31169',
                          '96249','88897','41849','37842','33899',
                          '79779','44418','89162','57192','45537',
                          '14973','83809','25043','77356','43747',
                          '67898','16321','22664','53409','83596',
                          '65353','73116','56027','32207','65725',
                          '50717','77590','24044','80014','13642',
                          '37032','44349','92605','39010','10221',
                          '38104','50092','69734','54798','53379',
                          '52953','16812','36533','13948','51978',
                          '62548','40927','61664','67962','74377',
                          '92351','86009','74730','78471','43056',
                          '81664','72952','51129','44939','56277',
                          '78107','77811','78833','89458','54702',
                          '74661','81605','76882','51230','53309',
                          '79972','86816','90457','51486','63777',
                          '57362','51096','93318','71024','45244',
                          '59072','52541','22477','62678','59242',
                          '68005','66457','56461','81851','50050',
                          '45154','47584','56871','80749','38772',
                          '17461','21095','59469','10796','91195',
                          '63248','31329','64373','64753','47974',
                          '42976','48220','24212','68260','57412',
                          '48105','51946','28093','23344','88833',
                          '14643','94703','26364','30209','91290',
                          '34919','93526','58954','31139','28012',
                          '37187','87384','63008','51614','74187',
                          '75634','73176','85012','40494','83468',
                          '62078','29641','50845','62259','90476',
                          '92756','64699','79718','32820','38457',
                          '55275','79775','29289','50673','45411',
                          '18397','56565','34095','95625','69629',
                          '71324','79163','91738','89919','19996',
                          '38345','59565','67084','21155','83436',
                          '35792','64660','34604','89604','63155',
                          '41370','87443','79160','81712','85288',
                          '27537','84649','81496','80279','56193',
                          '84506','93611','97166','88390','79204',
                          '14096','14061','39004','74563','56780',
                          '69745','80620','52014','23220','98832',
                          '15434','96125','72660','81634','54373',
                          '57861','61180','71114','45130','82376',
                          '39294','88980','28727','42664','48722',
                          '39736','18380','30920','96419','59694',
                          '77140','93035','97481','19558','32186',
                          '23201','73037','98383','31334','54760',
                          '20489','85151','65788','93261','17238',
                          '71239','95723','86742','88623','58592',
                          '75985','68269','21110','72257','31210',
                          '29016','85758','25355','83386','54341',
                          '21844','56045','24276','10326','32090',
                          '43226','98597','85663','75585','80226',
                          '34135','98714','29596','96365','84340',
                          '49260','45493','13722','46136','25698',
                          '79596','31013','59792','49407','15701',
                          '13152','97685','88696','62326','17208',
                          '87813','91138','60978','32272')
     intersect
      select ca_zip
...
select  i_item_id
 ...
 and d_date between cast(date('2002-04-17') as date) and (cast(date('2002-04-17') as date) + interval '60' day)
 and i_manufact_id in (930,721,850,858)
...
select   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2002
 	and t_time between 51378 and 51378+28800 
...
select  *
 from(select w_warehouse_name
            ,i_item_id
            ,sum(case when (cast(d_date as date) < cast (date('1998-04-28') as date))
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between (cast (date('1998-04-28') as date) - interval '30' day)
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast(date('2000-01-26') as date) and (cast(date('2000-01-26') as date) + interval '60' day)
 and i_manufact_id in (833,326,760,39)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Five Points','Oak Grove','Riverside','Midway','Pleasant Hill') 
 ...
 where i_manufact_id between 892 and 892+40 
   and (select count(*) as item_cnt
       ...
       (i_manufact = i1.i_manufact and
        ...
        (i_category = 'Women' and
        (i_color = 'pink' or i_color = 'chiffon') and
...
select  
   w_state
  ,i_item_id
  ,sum(case when (cast(d_date as date) < cast (date('1999-05-25') as date)) 
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast (date('1999-05-25') as date) - interval '30' day)
                and (cast (date('1999-05-25') as date) + interval '30' day) 
 group by
    w_state,i_item_id
...
i_manufact_id = 921
and i_item_sk = ws_item_sk 
and d_date between date(date('2002-02-11')) and 
        (cast(date('2002-02-11') as date) + interval '90' day)
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in (date('2001-03-17'),date('2001-08-28'),date('2001-11-23'))))
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 107 and 107+10 
             or ss_coupon_amt between 12241 and 12241+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 2 and 2+10
          or ss_coupon_amt between 8503 and 8503+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 130 and 130+10
          or ss_coupon_amt between 12749 and 12749+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 141 and 141+10
          or ss_coupon_amt between 5508 and 5508+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 78 and 78+10
          or ss_coupon_amt between 4816 and 4816+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 47 and 47+10
          or ss_coupon_amt between 11732 and 11732+1000
...
where 
	ws_item_sk = i_item_sk 
  	...
  	and ws_sold_date_sk = d_date_sk
	and d_date between cast(date('2000-06-18') as date) 
				and (cast(date('2000-06-18') as date) + interval '30' day)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('plum','gainsboro','light','pale','sandy','blue') and
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 252101
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 343638
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 195184
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 361089
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 237541
            then (select avg(ss_ext_list_price)
                  from store_sales
...
i_manufact_id = 544
and i_item_sk = cs_item_sk 
and d_date between date(date('2000-02-04')) and 
        (cast(date('2000-02-04') as date) + interval '90' day)
...
where 
	ss_item_sk = i_item_sk 
  	...
  	and ss_sold_date_sk = d_date_sk
	and d_date between cast(date('1999-02-28') as date) 
				and (cast(date('1999-02-28') as date) + interval '30' day)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
with ss as
 ...
 from store_sales,
      ...
      store
 where ss_sold_date_sk = d_date_sk
       and d_date between cast(date('2000-08-05') as date) 
                  and (cast(date('2000-08-05') as date) + interval '30' day) 
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
