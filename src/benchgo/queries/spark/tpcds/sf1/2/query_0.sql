...
select  i_item_id
 ...
 and d_date between cast(date('2001-06-09') as date) and (cast(date('2001-06-09') as date) + interval '60' day)
...
where 
	ss_item_sk = i_item_sk 
  	...
  	and ss_sold_date_sk = d_date_sk
	and d_date between cast(date('2000-01-05') as date) 
				and (cast(date('2000-01-05') as date) + interval '30' day)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
i_manufact_id = 914
and i_item_sk = ws_item_sk 
and d_date between date(date('2001-01-25')) and 
        (cast(date('2001-01-25') as date) + interval '90' day)
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast(date('1998-06-06') as date) and (cast(date('1998-06-06') as date) + interval '60' day)
...
select  
   w_state
  ,i_item_id
  ,sum(case when (cast(d_date as date) < cast (date('2002-05-18') as date)) 
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast (date('2002-05-18') as date) - interval '30' day)
