...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('2001-08-09' as date) 
                  and (cast('2001-08-09' as date) +  14 days)
...
select  i_item_id
 ...
 and d_date between cast('1999-06-18' as date) and (cast('1999-06-18' as date) +  60 days)
...
select  
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('1999-02-02' as date) - 30 days)
                and (cast ('1999-02-02' as date) + 30 days) 
 group by
    w_state,i_item_id
...
and d_date between '2001-02-25' and 
        (cast('2001-02-25' as date) + 90 days)
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2001-01-28','2001-09-14','2001-11-19')))
...
where 
	...
	and d_date between cast('1999-03-04' as date) 
				and (cast('1999-03-04' as date) + 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select  i_item_id
 ...
 and d_date between cast('1999-02-14' as date) 
 				and (cast('1999-02-14' as date) + 30 days)
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
