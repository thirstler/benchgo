...
and d_date between '1999-03-14' and 
        (cast('1999-03-14' as date) + 90 days)
...
and d_date between '2002-02-13' and 
        (cast('2002-02-13' as date) + 90 days)
...
where 
	...
	and d_date between cast('1999-03-08' as date) 
				and (cast('1999-03-08' as date) + 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
with ssr as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('1998-08-23' as date) 
                  and (cast('1998-08-23' as date) +  30 days)
...
select  i_item_id
 ...
 and d_date between cast('2002-05-01' as date) and (cast('2002-05-01' as date) +  60 days)
...
select  
 ...
 and cs_warehouse_sk    = w_warehouse_sk 
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('2002-02-26' as date) - 30 days)
                and (cast ('2002-02-26' as date) + 30 days) 
 group by
    w_state,i_item_id
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2001-06-19' as date) and (cast('2001-06-19' as date) +  60 days)
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('1998-06-29','1998-09-28','1998-11-02')))
...
with ss as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('1998-08-16' as date) 
                  and (cast('1998-08-16' as date) +  30 days) 
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
