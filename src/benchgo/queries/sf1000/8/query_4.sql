...
and d_date between '1998-03-09' and 
        (cast('1998-03-09' as date) + 90 days)
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2001-03-18','2001-09-04','2001-11-19')))
...
select  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between (cast ('2002-03-27' as date) - 30 days)
                    and (cast ('2002-03-27' as date) + 30 days)
...
select  
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('1999-05-29' as date) - 30 days)
                and (cast ('1999-05-29' as date) + 30 days) 
 group by
    w_state,i_item_id
...
select  i_item_id
 ...
 and d_date between cast('1999-03-06' as date) and (cast('1999-03-06' as date) +  60 days)
...
and d_date between '2001-01-18' and 
        (cast('2001-01-18' as date) + 90 days)
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2002-04-30' as date) and (cast('2002-04-30' as date) +  60 days)
...
select  i_item_id
 ...
 where cs_item_sk = i_item_sk 
   ...
   and cs_sold_date_sk = d_date_sk
 and d_date between cast('1998-03-30' as date) 
 				and (cast('1998-03-30' as date) + 30 days)
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
where 
	...
	and d_date between cast('1999-03-29' as date) 
				and (cast('1999-03-29' as date) + 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('2000-08-28' as date) 
                  and (cast('2000-08-28' as date) +  14 days)
