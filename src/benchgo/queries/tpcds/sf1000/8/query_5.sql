...
where 
	...
	and d_date between cast('2001-06-17' as date) 
				and (cast('2001-06-17' as date) + 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between (cast ('1999-02-12' as date) - 30 days)
                    and (cast ('1999-02-12' as date) + 30 days)
...
and d_date between '2000-03-13' and 
        (cast('2000-03-13' as date) + 90 days)
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('1998-07-02','1998-08-20','1998-11-13')))
...
select  
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('1998-05-20' as date) - 30 days)
                and (cast ('1998-05-20' as date) + 30 days) 
 group by
    w_state,i_item_id
...
select  i_item_id
 ...
 where cs_item_sk = i_item_sk 
   ...
   and cs_sold_date_sk = d_date_sk
 and d_date between cast('2001-06-12' as date) 
 				and (cast('2001-06-12' as date) + 30 days)
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('1999-08-29' as date) 
                  and (cast('1999-08-29' as date) +  14 days)
...
where 
	ws_item_sk = i_item_sk 
  	...
  	and ws_sold_date_sk = d_date_sk
	and d_date between cast('1998-01-17' as date) 
				and (cast('1998-01-17' as date) + 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2000-04-05' as date) and (cast('2000-04-05' as date) +  60 days)
