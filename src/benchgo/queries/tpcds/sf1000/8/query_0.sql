...
select  i_item_id
 ...
 and d_date between cast('1998-04-29' as date) and (cast('1998-04-29' as date) +  60 days)
...
and d_date between '2001-01-26' and 
        (cast('2001-01-26' as date) + 90 days)
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('1998-01-18' as date) and (cast('1998-01-18' as date) +  60 days)
...
select  
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('2002-05-10' as date) - 30 days)
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('1999-05-18','1999-09-26','1999-11-14')))
