...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2002-02-01','2002-10-21','2002-11-04')))
...
and d_date between '1999-02-15' and 
        (cast('1999-02-15' as date) + 90 days)
...
with ss as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2001-08-07' as date) 
                  and (cast('2001-08-07' as date) +  30 days) 
...
select  
   w_state
  ,i_item_id
  ,sum(case when (cast(d_date as date) < cast ('2002-05-16' as date)) 
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('2002-05-16' as date) - 30 days)
                and (cast ('2002-05-16' as date) + 30 days) 
 group by
    w_state,i_item_id
...
where 
	...
	and d_date between cast('2000-05-14' as date) 
				and (cast('2000-05-14' as date) + 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('2002-08-05' as date) 
                  and (cast('2002-08-05' as date) +  14 days)
...
select  i_item_id
 ...
 and d_date between cast('2001-02-13' as date) and (cast('2001-02-13' as date) +  60 days)
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2001-04-14' as date) and (cast('2001-04-14' as date) +  60 days)
