...
select  i_item_id
 ...
 and d_date between cast('1999-03-27' as date) and (cast('1999-03-27' as date) +  60 days)
...
select  
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('1998-03-13' as date) - 30 days)
                and (cast ('1998-03-13' as date) + 30 days) 
 group by
    w_state,i_item_id
