...
where 
	ss_item_sk = i_item_sk 
  	...
  	and ss_sold_date_sk = d_date_sk
	and d_date between cast('2002-01-15' as date) 
				and (cast('2002-01-15' as date) + 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2002-06-15','2002-09-15','2002-11-08')))
...
select  
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('2000-04-21' as date) - 30 days)
                and (cast ('2000-04-21' as date) + 30 days) 
 group by
    w_state,i_item_id
...
select  i_item_id
 ...
 and d_date between cast('2001-05-05' as date) 
 				and (cast('2001-05-05' as date) + 30 days)
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
where 
	ws_item_sk = i_item_sk 
  	...
  	and ws_sold_date_sk = d_date_sk
	and d_date between cast('1999-05-18' as date) 
				and (cast('1999-05-18' as date) + 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select  i_item_id
 ...
 and d_date between cast('1999-01-08' as date) and (cast('1999-01-08' as date) +  60 days)
