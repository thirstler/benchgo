...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast(date(date('2000-08-21')) as date) 
                  and (cast(date(date('2000-08-21')) as date) + interval '14' day)
 ...
 where ss_item_sk = i_item_sk
   and d_date in (select d_date
                  ...
                  where d_week_seq = (select d_week_seq 
                                      from date_dim
                                      where d_date = date(date('1998-07-03'))))
...
select  i_item_id
 ...
 from	catalog_sales
     ...
     ,date_dim
 where cs_item_sk = i_item_sk 
   and i_category in ('Women', 'Shoes', 'Music')
   and cs_sold_date_sk = d_date_sk
 and d_date between cast(date(date('2000-04-19')) as date) 
 				and (cast(date(date('2000-04-19')) as date) + interval '30' day)
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 468429
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 125725
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 90989
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 142641
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 202389
            then (select avg(ss_ext_list_price)
                  from store_sales
...
and d_date between date(date(date('1998-01-19'))) and 
        (cast(date(date('1998-01-19')) as date) + interval '90' day)
...
where ss_item_sk = i_item_sk and
      ...
      ss_store_sk = s_store_sk and
      d_year in (1998) and
        ((i_category in ('Shoes','Children','Women') and
          i_class in ('womens','school-uniforms','swimwear')
         )
      or (i_category in ('Sports','Music','Electronics') and
          i_class in ('fishing','country','automotive') 
        ))
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 56 and 56+10 
             or ss_coupon_amt between 12686 and 12686+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 136 and 136+10
          or ss_coupon_amt between 13051 and 13051+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 138 and 138+10
          or ss_coupon_amt between 12026 and 12026+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 7 and 7+10
          or ss_coupon_amt between 7304 and 7304+1000
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (7,1,6,3,5,10) and
       d_year = 2001 and
       ca_state in ('KS','AR','GA'
                   ,'FL','LA','TX','CA')
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Springfield'
   ...
   and ib_lower_bound   >=  19634
   and ib_upper_bound   <=  19634 + 50000
...
select  i_item_id
 ...
 and d_date between cast(date(date('2002-03-12')) as date) and (cast(date(date('2002-03-12')) as date) + interval '60' day)
 and i_manufact_id in (874,56,863,186)
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '65356','73192','83586','43503','27771','12542',
                          '57780','92734','81827','57854','27604',
                          '21123','57913','25414','41419','70238',
                          '63798','78776','67451','94780','16546',
                          '25812','78084','92746','54255','74847',
                          '15955','50669','59267','45719','97204',
                          '76790','61345','15251','54318','29587',
                          '92700','58579','88844','23788','77041',
                          '85152','53402','32924','17605','28990',
                          '24140','10521','54751','97459','25364',
                          '67311','96521','82609','32940','94113',
                          '90663','54658','94055','62700','89812',
                          '12984','81513','75704','21755','99445',
                          '99430','79281','13077','11941','70683',
                          '25169','17453','14439','92828','44635',
                          '85070','24198','75970','40610','72065',
                          '89766','49892','16345','62927','76296',
                          '93817','74245','39102','87476','62614',
                          '91601','54071','30571','23051','50450',
                          '34347','61110','48938','64354','90292',
                          '35800','74685','34405','98565','85738',
                          '23093','24611','75626','38441','67766',
                          '18062','81615','19557','19989','44740',
                          '15682','26244','58768','11714','89721',
                          '57601','71531','44468','49978','43079',
                          '12969','17165','28186','68081','61115',
                          '37814','86449','75179','73811','84013',
                          '29020','14779','48878','45203','26286',
                          '26012','43323','88025','55728','69793',
                          '18306','51808','59745','80011','31440',
                          '83978','80186','56651','13978','97579',
                          '30762','59885','40148','51205','95967',
                          '81029','15456','45360','87781','34430',
                          '37521','19231','74641','86326','42004',
                          '21175','15576','13008','68805','12036',
                          '82488','59014','49383','75884','20255',
                          '81417','65632','15221','91401','22193',
                          '50788','70577','12989','45834','33977',
                          '85381','17979','15893','17760','32865',
                          '40340','25735','66749','88689','21338',
                          '10351','94531','70693','99147','67227',
                          '13724','78078','64662','10688','55170',
                          '76209','14760','77224','22211','56658',
                          '63231','94207','70366','28015','55893',
                          '10923','30998','22132','32405','55825',
                          '16108','85460','33258','72341','24143',
                          '80313','63883','25850','46493','36651',
                          '12038','71881','55083','34653','66083',
                          '49933','99930','53796','75173','19210',
                          '68693','22637','12666','56145','28930',
                          '68705','54378','22255','81673','98538',
                          '16456','34031','18277','46167','29066',
                          '93913','19946','83741','69510','47444',
                          '99188','56827','22140','79021','83609',
                          '58050','56028','88474','78008','79388',
                          '74982','76803','12010','46189','82175',
                          '80423','42673','49337','77368','91516',
                          '70434','50202','36490','53294','44901',
                          '39326','72672','82473','81686','42110',
                          '20829','35921','77735','57578','48590',
                          '36269','54703','14381','20954','11362',
                          '82504','98509','33577','32640','24416',
                          '92988','68666','87058','57829','71638',
                          '34241','99696','17625','38764','37110',
                          '73488','10677','62490','60232','76663',
                          '53574','38456','29760','43404','64379',
                          '10564','21410','29213','63393','10020',
                          '28254','40364','29967','86384','10174',
                          '52726','57564','98592','60990','51623',
                          '43818','47691','10352','84299','12608',
                          '42086','41487','97420','48166','59972',
                          '22828','63143','45868','45009','82730',
                          '54407','50535','38172','55017','16858',
                          '46546','91166','28671','67520','86769',
                          '41783','45718','30393','77200','33425',
                          '43421','92222','71661','78402','55374',
                          '79640','35789','16766','73113','94622',
                          '37033','83957','27987','52865','69282',
                          '73953','22737','39117','97220','41501',
                          '43366','54084','37745','64322')
     intersect
      select ca_zip
...
select  distinct(i_product_name)
 ...
 where i_manufact_id between 978 and 978+40 
   and (select count(*) as item_cnt
        ...
        (i_category = 'Men' and
        (i_color = 'medium' or i_color = 'snow') and
        (i_units = 'N/A' or i_units = 'Case') and
        (i_size = 'N/A' or i_size = 'extra large')
        ) or
        (i_category = 'Men' and
        (i_color = 'dodger' or i_color = 'ivory') and
        (i_units = 'Bunch' or i_units = 'Tsp') and
        (i_size = 'petite' or i_size = 'economy')
        ))) or
       (i_manufact = i1.i_manufact and
        ((i_category = 'Women' and 
        (i_color = 'magenta' or i_color = 'coral') and 
...
with ss as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast(date(date('1998-08-04')) as date) 
                  and (cast(date(date('1998-08-04')) as date) + interval '30' day) 
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
...
where 
	ss_item_sk = i_item_sk 
  	...
  	and ss_sold_date_sk = d_date_sk
	and d_date between cast(date(date('1998-02-05')) as date) 
				and (cast(date(date('1998-02-05')) as date) + interval '30' day)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('floral','royal','dark'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 1999
 and     d_moy                   = 5
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast(date(date('1998-05-27')) as date) and (cast(date(date('1998-05-27')) as date) + interval '60' day)
 and i_manufact_id in (757,818,977,733)
 and inv_quantity_on_hand between 100 and 500
 and cs_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Houston County','Crittenden County','Young County','Atascosa County','Orange County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
select  *
 from(select w_warehouse_name
            ,i_item_id
            ,sum(case when (cast(d_date as date) < cast (date(date('2002-02-25')) as date))
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between (cast (date(date('2002-02-25')) as date) - interval '30' day)
                    and (cast (date(date('2002-02-25')) as date) + interval '30' day)
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in (date(date('2001-05-26')),date(date('2001-09-10')),date(date('2001-11-05')))))
...
i_manufact_id = 26
and i_item_sk = ws_item_sk 
and d_date between date(date(date('1999-01-09'))) and 
        (cast(date(date('1999-01-09')) as date) + interval '90' day)
...
where 
	ws_item_sk = i_item_sk 
  	...
  	and ws_sold_date_sk = d_date_sk
	and d_date between cast(date(date('2001-04-16')) as date) 
				and (cast(date(date('2001-04-16')) as date) + interval '30' day)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('orchid','linen','blush','drab','blanched','ivory') and
...
select   
 ...
 from (
 	...
 	,w_state
 	,w_country
 	,'ORIENTAL' || ',' || 'LATVIAN' as ship_carriers
       ,d_year as year
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 1998
 	and t_time between 43089 and 43089+28800 
 	and sm_carrier in ('ORIENTAL','LATVIAN')
     group by 
        w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('TX', 'NJ', 'MS')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('MT', 'MO', 'WV')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('CA', 'OH', 'AR')
...
select  
   w_state
  ,i_item_id
  ,sum(case when (cast(d_date as date) < cast (date(date('2001-05-10')) as date)) 
 ...
 and cs_warehouse_sk    = w_warehouse_sk 
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast (date(date('2001-05-10')) as date) - interval '30' day)
                and (cast (date(date('2001-05-10')) as date) + interval '30' day) 
 group by
    w_state,i_item_id
