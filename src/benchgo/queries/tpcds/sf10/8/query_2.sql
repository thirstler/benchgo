...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('1999-08-12' as date) 
                  and (cast('1999-08-12' as date) +  14 days)
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2002-02-16','2002-08-02','2002-11-09')))
...
select  *
 from(select w_warehouse_name
            ,i_item_id
            ,sum(case when (cast(d_date as date) < cast ('2002-04-16' as date))
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between (cast ('2002-04-16' as date) - 30 days)
                    and (cast ('2002-04-16' as date) + 30 days)
...
select  i_item_id
 ...
 and d_date between cast('1999-02-19' as date) and (cast('1999-02-19' as date) +  60 days)
...
select  
 ...
 and cs_warehouse_sk    = w_warehouse_sk 
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('2001-04-28' as date) - 30 days)
                and (cast ('2001-04-28' as date) + 30 days) 
 group by
    w_state,i_item_id
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2002-06-30' as date) and (cast('2002-06-30' as date) +  60 days)
...
where 
	...
	and d_date between cast('2001-06-18' as date) 
				and (cast('2001-06-18' as date) + 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
and d_date between '2001-02-03' and 
        (cast('2001-02-03' as date) + 90 days)
...
and d_date between '2001-03-18' and 
        (cast('2001-03-18' as date) + 90 days)
