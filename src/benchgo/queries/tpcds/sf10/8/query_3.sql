...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('2002-08-24' as date) 
                  and (cast('2002-08-24' as date) +  14 days)
...
select  i_item_id
 ...
 and d_date between cast('2002-04-17' as date) and (cast('2002-04-17' as date) +  60 days)
...
select  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between (cast ('1998-04-28' as date) - 30 days)
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2000-01-26' as date) and (cast('2000-01-26' as date) +  60 days)
...
select  
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('1999-05-25' as date) - 30 days)
...
and d_date between '2002-02-11' and 
        (cast('2002-02-11' as date) + 90 days)
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2001-03-17','2001-08-28','2001-11-23')))
...
where 
	...
	and d_date between cast('2000-06-18' as date) 
				and (cast('2000-06-18' as date) + 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
and d_date between '2000-02-04' and 
        (cast('2000-02-04' as date) + 90 days)
...
where 
	...
	and d_date between cast('1999-02-28' as date) 
				and (cast('1999-02-28' as date) + 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
