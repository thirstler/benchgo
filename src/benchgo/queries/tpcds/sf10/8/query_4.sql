...
and d_date between '1998-01-14' and 
        (cast('1998-01-14' as date) + 90 days)
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2001-06-11','2001-08-24','2001-11-13')))
...
select  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between (cast ('1999-02-21' as date) - 30 days)
...
select  
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('2001-05-14' as date) - 30 days)
...
select  i_item_id
 ...
 and d_date between cast('2000-01-13' as date) and (cast('2000-01-13' as date) +  60 days)
...
and d_date between '1999-03-31' and 
        (cast('1999-03-31' as date) + 90 days)
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('1998-06-03' as date) and (cast('1998-06-03' as date) +  60 days)
...
where 
	ws_item_sk = i_item_sk 
  	...
  	and ws_sold_date_sk = d_date_sk
	and d_date between cast('1998-04-26' as date) 
				and (cast('1998-04-26' as date) + 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('2000-08-11' as date) 
                  and (cast('2000-08-11' as date) +  14 days)
