...
and d_date between '1998-03-17' and 
        (cast('1998-03-17' as date) + 90 days)
...
where 
	...
	and d_date between cast('2002-03-05' as date) 
				and (cast('2002-03-05' as date) + 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select  i_item_id
 ...
 and d_date between cast('1998-07-04' as date) and (cast('1998-07-04' as date) +  60 days)
...
select  
 ...
 and cs_warehouse_sk    = w_warehouse_sk 
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('2001-04-18' as date) - 30 days)
                and (cast ('2001-04-18' as date) + 30 days) 
 group by
    w_state,i_item_id
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2001-04-17' as date) and (cast('2001-04-17' as date) +  60 days)
...
where 
	...
	and d_date between cast('1998-01-04' as date) 
				and (cast('1998-01-04' as date) + 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
