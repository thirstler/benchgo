...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('2001-08-27' as date) 
                  and (cast('2001-08-27' as date) +  14 days)
...
select  i_item_id
 ...
 and d_date between cast('2002-04-12' as date) 
 				and (cast('2002-04-12' as date) + 30 days)
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
with ssr as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('1998-08-19' as date) 
                  and (cast('1998-08-19' as date) +  30 days)
       and ss_store_sk = s_store_sk
...
and d_date between '2002-03-03' and 
        (cast('2002-03-03' as date) + 90 days)
...
select  i_item_id
 ...
 and d_date between cast('1998-07-17' as date) and (cast('1998-07-17' as date) +  60 days)
...
where 
	...
	and d_date between cast('2000-02-29' as date) 
				and (cast('2000-02-29' as date) + 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('1998-03-24' as date) and (cast('1998-03-24' as date) +  60 days)
