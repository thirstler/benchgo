...
and d_date between '2001-02-12' and 
        (cast('2001-02-12' as date) + 90 days)
...
where 
	...
	and d_date between cast('2000-03-16' as date) 
				and (cast('2000-03-16' as date) + 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between (cast ('1998-05-28' as date) - 30 days)
...
select  
 ...
 and cs_warehouse_sk    = w_warehouse_sk 
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('2002-03-13' as date) - 30 days)
                and (cast ('2002-03-13' as date) + 30 days) 
 group by
    w_state,i_item_id
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('1998-06-25' as date) and (cast('1998-06-25' as date) +  60 days)
...
where 
	...
	and d_date between cast('1998-05-01' as date) 
				and (cast('1998-05-01' as date) + 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
with ss as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2001-08-26' as date) 
                  and (cast('2001-08-26' as date) +  30 days) 
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
