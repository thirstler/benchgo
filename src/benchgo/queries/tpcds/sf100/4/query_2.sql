...
where 
	...
	and d_date between cast('1998-06-04' as date) 
				and (cast('1998-06-04' as date) + 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2001-02-28','2001-09-23','2001-11-03')))
...
select  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between (cast ('2001-03-07' as date) - 30 days)
                    and (cast ('2001-03-07' as date) + 30 days)
...
select  i_item_id
 ...
 and d_date between cast('2002-02-26' as date) and (cast('2002-02-26' as date) +  60 days)
...
select  
   w_state
  ,i_item_id
  ,sum(case when (cast(d_date as date) < cast ('1999-04-10' as date)) 
 ...
 and cs_warehouse_sk    = w_warehouse_sk 
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('1999-04-10' as date) - 30 days)
                and (cast ('1999-04-10' as date) + 30 days) 
 group by
    w_state,i_item_id
...
select  i_item_id
 ...
 and d_date between cast('1998-04-22' as date) 
 				and (cast('1998-04-22' as date) + 30 days)
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
and d_date between '1998-02-16' and 
        (cast('1998-02-16' as date) + 90 days)
...
and d_date between '2002-03-13' and 
        (cast('2002-03-13' as date) + 90 days)
