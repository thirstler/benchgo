...
select  i_item_id
 ...
 and d_date between cast('2001-02-11' as date) and (cast('2001-02-11' as date) +  60 days)
...
where 
	...
	and d_date between cast('2002-05-27' as date) 
				and (cast('2002-05-27' as date) + 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('1998-01-23' as date) and (cast('1998-01-23' as date) +  60 days)
...
with ss as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('1998-08-21' as date) 
                  and (cast('1998-08-21' as date) +  30 days) 
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
...
select  
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('2002-05-08' as date) - 30 days)
                and (cast ('2002-05-08' as date) + 30 days) 
 group by
    w_state,i_item_id
...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('2002-08-09' as date) 
                  and (cast('2002-08-09' as date) +  14 days)
