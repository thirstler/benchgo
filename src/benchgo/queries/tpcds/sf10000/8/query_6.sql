...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('2000-08-20' as date) 
                  and (cast('2000-08-20' as date) +  14 days)
...
with ssr as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('1999-08-23' as date) 
                  and (cast('1999-08-23' as date) +  30 days)
       and ss_store_sk = s_store_sk
...
and d_date between '2001-02-02' and 
        (cast('2001-02-02' as date) + 90 days)
...
with ss as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2000-08-24' as date) 
                  and (cast('2000-08-24' as date) +  30 days) 
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('1998-06-01' as date) and (cast('1998-06-01' as date) +  60 days)
...
select  *
 from(select w_warehouse_name
            ,i_item_id
            ,sum(case when (cast(d_date as date) < cast ('2000-05-23' as date))
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between (cast ('2000-05-23' as date) - 30 days)
                    and (cast ('2000-05-23' as date) + 30 days)
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2002-02-05','2002-08-15','2002-11-17')))
...
i_manufact_id = 305
and i_item_sk = ws_item_sk 
and d_date between '1998-02-20' and 
        (cast('1998-02-20' as date) + 90 days)
...
where 
	...
	and d_date between cast('1999-06-20' as date) 
				and (cast('1999-06-20' as date) + 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select  
 ...
 and cs_warehouse_sk    = w_warehouse_sk 
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('1998-02-23' as date) - 30 days)
                and (cast ('1998-02-23' as date) + 30 days) 
 group by
    w_state,i_item_id
