...
select  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between (cast ('2000-06-19' as date) - 30 days)
                    and (cast ('2000-06-19' as date) + 30 days)
...
and d_date between '1998-02-03' and 
        (cast('1998-02-03' as date) + 90 days)
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2002-01-26','2002-09-23','2002-11-14')))
...
select  
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('2000-04-25' as date) - 30 days)
                and (cast ('2000-04-25' as date) + 30 days) 
 group by
    w_state,i_item_id
...
select  i_item_id
 ...
 and d_date between cast('1999-03-18' as date) 
 				and (cast('1999-03-18' as date) + 30 days)
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
where 
	...
	and d_date between cast('2002-06-29' as date) 
				and (cast('2002-06-29' as date) + 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2002-05-03' as date) and (cast('2002-05-03' as date) +  60 days)
