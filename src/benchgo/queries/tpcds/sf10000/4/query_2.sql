...
where 
	...
	and d_date between cast('1998-05-21' as date) 
				and (cast('1998-05-21' as date) + 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('2002-08-26' as date) 
                  and (cast('2002-08-26' as date) +  14 days)
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2000-05-22','2000-08-02','2000-11-12')))
...
with ss as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('1999-08-28' as date) 
                  and (cast('1999-08-28' as date) +  30 days) 
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
...
select  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between (cast ('2001-06-15' as date) - 30 days)
...
select  i_item_id
 ...
 and d_date between cast('1998-06-29' as date) and (cast('1998-06-29' as date) +  60 days)
...
select  
   w_state
  ,i_item_id
  ,sum(case when (cast(d_date as date) < cast ('2000-04-13' as date)) 
 ...
 and cs_warehouse_sk    = w_warehouse_sk 
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('2000-04-13' as date) - 30 days)
                and (cast ('2000-04-13' as date) + 30 days) 
 group by
    w_state,i_item_id
...
and d_date between '2002-03-08' and 
        (cast('2002-03-08' as date) + 90 days)
...
and d_date between '1998-02-08' and 
        (cast('1998-02-08' as date) + 90 days)
